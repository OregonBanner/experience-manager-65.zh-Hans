...
1. 在 **高级** 选项卡，使用 **目标语言** 下拉列表以选择应将内容翻译成的语言。 点按或单击&#x200B;**创建**。
...
您可以使用前面的步骤将必要的内容添加到项目的所有语言（作业）中。 选择所有内容后，即可开始翻译。
...
[如前所述，](#using-translation-project) 机器翻译的内容流回AEM，状态为 **已批准** 因为假定使用的是机器翻译，所以不需要人工干预。 但是，仍可以查看已翻译的内容。
...
在此知识的基础上继续您的AEM Headless翻译历程，接下来查看文档 [发布翻译的内容](publish-content.md) 在这里，您可以了解如何发布翻译的内容以及如何在语言根内容发生更改时更新这些翻译。
