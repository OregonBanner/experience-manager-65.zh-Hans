...
Adobe Experience Manager(AEM)提供了多个用于开发应用程序和扩展AEM的API。 以下列表提供了AEM支持的API文档：
...
* **内容片段** (CF): [资产HTTP API中的CF支持](/help/assets/assets-api-content-fragments.md) 和 [AEM Assets API — 内容片段](https://www.adobe.io/experience-manager/reference-materials/6-5/assets-api-content-fragments/index.html)
