...
要保存jsontest.com站点的MD5服务中的数据，请使用[使用以下属性创建ContextHub Store](/help/sites-developing/ch-configuring.md#creating-a-contexthub-store)中的过程：
...
使用[添加UI模块](#adding-a-ui-module)中的步骤将UI模块添加到现有UI模式，如示例Perona UI模式。 对于UI模块，请使用以下属性值：
