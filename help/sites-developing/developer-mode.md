...
在Adobe Experience Manager (AEM)中编辑页面时，需要多个 [模式](/help/sites-authoring/author-environment-tools.md#modestouchoptimizedui) 可用，包括开发人员模式。 这将打开一个侧面板，其中包含多个选项卡，为开发人员提供有关当前页面的信息。 三个选项卡包括：
...
>* AEM Gems会话关于 [AEM 6.0开发人员模式](https://experienceleague.adobe.com/docs/events/experience-manager-gems-recordings/gems2014/aem-developer-mode.html?lang=en).
>
...
>[!CAUTION]
>
>某些链接指向下的脚本 `/libs`. 但是，这些仅供参考，您 **不得** 编辑下的任何内容 `/libs`，因为您所做的任何更改都可能会丢失。 这是因为每当您升级或应用修补程序或功能包时，此分支都可能会发生更改。 根据需要进行任何更改 `/apps`. 参见 [叠加和覆盖](/help/sites-developing/overlays.md).
...
例如，在调用未定义的方法的情况下，产生的错误显示在中 **错误** 选项卡：
...
>
>有关完整的详细信息，请参阅 [测试您的UI](/help/sites-developing/hobbes.md).
