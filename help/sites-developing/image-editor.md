---
title: 图像编辑器
description: 图像编辑器是AEM的核心部分，可供组件使用，以便于内容作者处理图像。
...
图像编辑器是AEM的核心部分，可供组件使用，以便于内容作者处理图像。

>[!CAUTION]
>
>要使用本文中描述的图像编辑器功能， [功能包24267](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq640/featurepack/cq-6.4.0-featurepack-24267) 必须安装。
