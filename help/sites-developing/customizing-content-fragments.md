...
* [创建和管理内容片](/help/assets/content-fragments/content-fragments.md) 段和使 [用内容片段进行页](/help/sites-authoring/content-fragments.md) 面创作，以了解有关内容片段的更多信息。

* [管理](/help/assets/manage-assets.md) 资产和 [自定义和扩](/help/assets/extending-assets.md) 展资产，以了解有关标准资产的更多信息。
...
>[!CAUTION]
>
>[现在，建](/help/assets/content-fragments/content-fragments-models.md) 议使用内容片段模型创建所有片段。
>
...
此参数可在[Web控制台](/help/sites-deploying/configuring-osgi.md#osgi-configuration-with-the-web-console)中为OSGi捆绑&#x200B;**内容片段组件配置**&#x200B;配置。
...
* **引**
用属性可以配置属性列表，以指定对片段的引用存储到相应组件的位置。
