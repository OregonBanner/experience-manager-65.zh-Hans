...
>[!NOTE]
>
>为了返回诊断信息，必须启用调试模式，否则诊断页面将为空白。 请参阅 [本文档](ch-configuring.md#debugging-contexthub) 了解有关如何启用调试模式的详细信息。
...
* **标题：** 此 [存储类型](/help/sites-developing/ch-samplestores.md) 商店所基于的内容。
* **路径：** 保存该配置的存储库节点的路径。
