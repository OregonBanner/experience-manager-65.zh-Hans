...
>[!NOTE]
>
>要返回诊断信息，必须启用调试模式，否则诊断页面将为空。 请参阅 [本文档](ch-configuring.md#debugging-contexthub) 以了解有关如何启用调试模式的详细信息。
...
* **配置编辑器：** 打开 [“ContextHub配置”页](ch-configuring.md) 您可以在其中配置存储、UI模式和UI模块。
