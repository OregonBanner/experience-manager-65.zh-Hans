...
向ContextHub注册UI模块渲染器。 注册呈示器后，它可用于[创建UI模块](ch-configuring.md#adding-a-ui-module)。 当您是[扩展ContextHub.UI.BaseModuleRenderer](/help/sites-developing/ch-extend.md#creating-contexthub-ui-module-types)以创建自定义UI模块渲染器时，请使用此函数。
