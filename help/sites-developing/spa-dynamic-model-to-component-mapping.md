---
title: SPA的动态模型到组件映射
description: 了解动态模型到组件的映射如何在JavaScript SPA SDK for Adobe Experience Manager中发生。
...
参见 [SPA Blueprint](/help/sites-developing/spa-blueprint.md) 有关模型解析和前端组件访问模型的更多信息。
