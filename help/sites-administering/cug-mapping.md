...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>包含允许读取受限CUG下方内容的主体名称的属性受保护，无法使用常规JCR API调用写入；请改用JCR访问控制管理。</p> <p>参见 <a href="https://svn.apache.org/repos/asf/jackrabbit/trunk/jackrabbitapi/src/main/java/org/apache/jackrabbit/api/security/authorization/PrincipalSetPolicy.java">此页面</a> 以了解有关实施的更多详细信息。</p> </td>
  </tr>
  <tr>
