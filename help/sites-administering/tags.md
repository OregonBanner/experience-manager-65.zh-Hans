...
选择命名空间或其他标记后，选择 **引用** 图标可识别已应用标记的内容。
...
选择命名空间或其他标记后，选择 **合并** 图标将打开一个面板，其中可以选择要合并到的路径。
...
选择命名空间或其他标记后，选择 **发布** 图标以在发布环境中激活标记。 与页面内容类似，只会发布选定的标记，而不考虑该标记是否为容器标记。
...
选择命名空间或其他标记后，选择 **取消发布** 图标将在创作环境中停用标记，并将其从发布环境中删除。 与 `Delete`操作时，如果所选标记是容器标记，则其所有子标记将在创作环境中停用，并从发布环境中删除。

### 删除标记 {#deleting-tags}

![chlimage_1-203](assets/chlimage_1-203.png)

选择命名空间或其他标记后，选择 **删除** 图标将从创作环境中永久删除标记。 如果标记已发布，则也会从发布环境中将其删除。 如果所选标记是容器标记，则其所有子标记也将被删除。
