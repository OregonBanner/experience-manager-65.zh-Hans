...
有关可以使用AEM 6.5操作的资产最大数量的其他信息，请参阅[资产规模调整指南](/help/assets/assets-sizing-guide.md)。
...
要为通过Adobe激活(DTM)部署的Experience Manager设置和配置资产分析，请参阅如何[使用AEM Assets](https://docs.adobe.com/content/help/en/experience-manager-learn/assets/advanced/asset-insights-launch-tutorial.html)设置资产分析。
...
有关详细信息，请参阅[AEM Assets与AEM MediaLibrary](/help/assets/medialibrary.md)。
