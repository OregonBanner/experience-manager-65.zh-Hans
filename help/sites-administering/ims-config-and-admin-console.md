...
AEM入门 [!DNL Admin Console] 将允许AEM Managed Services客户在一个控制台中管理所有Experience Cloud用户。 可以将用户分配到与AEM实例关联的产品配置文件，以便他们登录到特定实例。
...
>
>
>此 [!DNL User Management] 本课程介绍了用户同步工具使用的API [位置](https://adobe-apiplatform.github.io/umapi-documentation/en/).
