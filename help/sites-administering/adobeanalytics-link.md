...
请执行以下步骤来探索Adobe Analytics集成的链接跟踪行为。 程序显示 [Adobe Marketing Cloud Debugger](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html).
