...
1. 从AEM主菜单 — > **工具** -> **部署** -> **包**
1. 起始日期 [CRXDE Lite](/help/sites-developing/developing-with-crxde-lite.md) 使用顶部切换栏
...
缩略图提供了包中所包含内容的快速引用可视化表示形式。 然后，它显示在包列表中，并帮助轻松识别包或包的类。
...
欲知更多信息，请参见 [软件分发文档。](https://experienceleague.adobe.com/docs/experience-cloud/software-distribution/home.html)

>[!NOTE]
>
>Package Manager当前未与Software Distribution集成，因为它与以前的Package Share服务集成。 因此，包管理器中的共享按钮以及指向包共享的其他链接不再有效。 解决方案是将包下载到本地磁盘。
