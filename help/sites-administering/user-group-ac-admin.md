...
添加访问控制条目时，可以选择以下权限(请参阅 [安全API](https://developer.adobe.com/experience-manager/reference-materials/spec/javax.jcr/javadocs/jcr-2.0/javax/jcr/security/Privilege.html) 了解完整详细信息)：
