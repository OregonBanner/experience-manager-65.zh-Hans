...
>[!NOTE]
>
>AEM会自动为[集合](/help/assets/manage-collections.md)中的角色分配（所有者、编辑者、查看器）生成用户组。 但是，手动为此类组添加ACL可能会在AEM中引入安全漏洞。 Adobe建议您避免手动添加ACL。
...
>[!NOTE]
>
>Adobe引入了新的基于触屏UI的权限管理主视图。 有关如何使用它的详细信息，请参阅[此页](/help/sites-administering/touch-ui-principal-view.md)。
