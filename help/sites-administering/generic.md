...
1. 根据需要修改和移动形状。
1. 单击形状。
1. 单击浏览图标可打开资产 [选取器](../assets/search-assets.md#assetselector)。
...
>[!NOTE]
>
>以下示例处理直接在营销活动中持有的 [促销](/help/sites-classic-ui-authoring/classic-personalization-campaigns.md)，它用于凭证。
>
>促销活动也可以包含在 [营销](/help/sites-authoring/personalization.md) 活动中的体验中。
>
>有关详细信息，请参 [阅Promotions and Vouchers](#promotions-and-vouchers)。
