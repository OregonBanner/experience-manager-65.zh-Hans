...
* [AEM快速入門](https://experienceleague.adobe.com/docs/experience-manager-65.html?lang=zh-Hans)
...
| 用户指南 | 描述 |
|--- |---|
| [发行说明](/help/release-notes/home.md) | 提供有關最新版AEM的重要資訊，包括新功能、支援的平台、已過時和已移除的功能，以及已知問題。 |
| [Assets 用户指南](/help/assets/home.md) | 瞭解如何建立、管理、提供和最佳化數位資產。 |
| [Forms使用手冊](/help/forms/home.md) | 本指南說明如何建立、管理、發佈和更新數位表格。 |
| [Communities使用手冊](/help/communities/home.md) | 创建在线体验，如论坛、用户组、学习资源和其他社交功能。 |
...
| [Commerce 用户指南](/help/commerce/home.md) | 瞭解AEM上的Commerce Integration Framework。 |
...
* [核心元件使用手冊](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=zh-Hans)
