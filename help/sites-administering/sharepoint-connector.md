...
可从[软件分发](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq630/featurepack/cq-6.3.0-featurepack-17673)下载SharePoint连接器。
...
1. 选择&#x200B;**绕过白名单**。
1. 在白名单包中添加默认`com.day.cq.dam.cq-dam-jcr-connectors`
1. 单击保存。
