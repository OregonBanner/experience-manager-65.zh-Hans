...
可以使用&#x200B;**GeometrixxNewsletter**&#x200B;模板在活动下创建要发布到电子邮件服务的电子邮件或新闻稿。 您还可以使用&#x200B;**Geometrixx Outdoors电子邮件**&#x200B;模板。 基于&#x200B;**Geometrixx Outdoors电子邮件**&#x200B;模板的示例电子邮件／新闻稿可在`https://<hostname>:<port>/cf#/content/campaigns/geometrixx-outdoors/e-mails.html`中找到。
...
1. 切换到编辑模式并开始向电子邮件中添加内容（文本、图像、[电子邮件工具](#adding-exacttarget-email-tools-to-your-email)、[个性化变量](#adding-text-and-personalization-tool-to-your-e-mail)等）。
...
ExactTarget的&#x200B;**电子邮件工具**&#x200B;组件可以向电子邮件/Newsletter添加更多电子邮件功能。
...
1. 从Sidekick添加组件&#x200B;**文本与个性化**。 此组件是新闻稿组的一部分。以编辑模式打开此组件。
...
1. 单击&#x200B;**发布**。这会打开&#x200B;**将Newsletter发布到电子邮件服务提供商**&#x200B;窗口。
