---
title: 使用页面版本
description: 版本控制可在特定时间点创建页面的“快照”。
...
1. 使用日期和时间选择器指定所需的日期/时间，然后单击 **开始**.
   ...
   >[!NOTE]
   >
   >如果您浏览到的页面已从存储库中删除/删除，但是如果该页面的旧版本仍然位于存储库中，则该页面将会正常呈现。
...
在下面的示例中，红线表示页面在初始绿色版本的时间范围内被编辑，黄线表示页面在红色版本等期间被编辑。

   ![chlimage_1-79](assets/chlimage_1-79.png)

1. 单击:

   1. **开始** 以在选定的时间点显示已发布页面的内容。
