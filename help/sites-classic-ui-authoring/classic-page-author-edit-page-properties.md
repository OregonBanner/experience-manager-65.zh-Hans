---
title: 编辑页面属性
description: 页面的属性可能会因页面的性质而异。 例如，某些页面可能连接到Live Copy，而其他页面未连接到，因此Live Copy信息将根据需要可用。
...
* **标记**
   ...
   * 当您将鼠标悬停在选择框中的标记条目上时，将显示x；这可用于删除此页面的标记。
...
* **虚 URL**
   ...
   用于输入此页面的虚URL。 这样可让您的URL更短、更具表现力。
...
页面属性定义页面的各种属性，例如标题，这些属性显示在网站和其他页面上。

1. 打开要编辑的页面。

1. 在副手手手上，打开 **页面** 选项卡，然后选择 **页面属性……**
