---
title: 了解分段
description: 分段是创建营销活动时的主要考虑事项。通常，在开始营销活动之前，必须已定义区段。
contentOwner: User
...
分段是创建营销活动时的主要考虑事项。通常，在开始营销活动之前，必须已定义区段。
...
>[!NOTE]
>
>参见 [分段](/help/sites-administering/campaign-segmentation.md) 有关Adobe Experience Manager中的区段的详细信息。
