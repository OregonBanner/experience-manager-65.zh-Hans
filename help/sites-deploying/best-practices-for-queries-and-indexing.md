...
如果要使用如下工具深入了解索引： [Luke](https://code.google.com/p/luke/)，您将需要使用Oak控制台转储来自的索引 `NodeStore` 到文件系统目录。 有关如何执行此操作的说明，请阅读 [Lucene文档](https://jackrabbit.apache.org/oak/docs/query/lucene.html).
