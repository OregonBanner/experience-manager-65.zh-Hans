...
1. 如果AEM已配置为使用Tar或MongoDB存储，请在继续操作之前，从****&lt;aem-install>***/*crx-quickstart*/*install* 文件夹删除任何现有配置文件。 需要删除的文件包括：
...
1. 通过打开页面到https://localhost:4502/etc/replication/agents.author/publish.html，转到复制代理设 *置*。
1. 按“设 **置** ”部分中的“编 **辑** ”按钮。
