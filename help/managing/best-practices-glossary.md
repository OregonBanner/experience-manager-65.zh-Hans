...
[Adobe安全检查表](/help/sites-administering/security-checklist.md)是为确保AEM安装安全而提供的正式检查表。 它包含您需要执行的安全措施和验证步骤，以确保实例的完整性。[](/help/sites-administering/security-checklist.md)
