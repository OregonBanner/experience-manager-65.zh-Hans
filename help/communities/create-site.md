...
在设置步骤中，选择之前 `Next`，请注意，有7个部分提供了对配置的访问权限，这些配置涉及用户管理、标记、审核、组管理、分析、翻译和启用。

访问 [AEM Communities启用入门](/help/communities/getting-started-enablement.md) 使用启用功能体验的教程。
...
对于类似的教程，请快速创建 [启用社区](/help/communities/overview.md#enablement-community)，请参见 [AEM Communities启用入门](/help/communities/getting-started-enablement.md).
