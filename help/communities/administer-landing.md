...
AEM Communities的主要功能是通过登录站点访客（成员）生成用户生成的内容(UGC)。 要了解有关使用UGC的更多信息，请访问：
...
* [Analytics配置](analytics.md): 使AdobeAnalytics能够报告与会员活动相关的各种指标
...
* [Analytics配置](analytics.md): 为AdobeAnalytics社区服务提供必要信息。
...
有关其他特定于Communities的信息(如升级、 [Dispatcher](upgrade.md)和复 [制](dispatcher.md) ), [请参](deploy-communities.md#replication-agents-on-author)阅“部署”页。
