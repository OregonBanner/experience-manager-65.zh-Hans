...
要使用这些API，您需要通过激活 **UserUgcManagement服务来启用** /services/social/ugcmanagement端点。 要激活此服务，请安装 [GitHub.com上提供的](https://github.com/Adobe-Marketing-Cloud/aem-communities-ugc-migration/tree/master/bundles/communities-ugc-management-servlet)[示例servlet](https://github.com/Adobe-Marketing-Cloud/aem-communities-ugc-migration/tree/master/bundles/communities-ugc-management-servlet)。 然后，使用HTTP请求(类似于
