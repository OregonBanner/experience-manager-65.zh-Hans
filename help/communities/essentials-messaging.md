...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>请参阅 <a href="/help/communities/configure-messaging.md" target="_blank">配置消息传递</a></td>
  </tr>
  <tr>
   <td><strong>管理员配置</strong></td>
   <td><a href="/help/communities/messaging.md">配置消息传递</a></td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   <td><strong>管理员配置</strong></td>
   <td><a href="/help/communities/messaging.md" target="_blank">配置消息传递</a></td>
  </tr>
 </tbody>
</table>
...
* [用于SCF组件的消息客户端](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/messaging/client/api/package-summary.html) API
...
使用向导创建的社区站点结构在选中时包括消息传递功能。 请参 `User Management` 阅“社区 [站点”控制台的设置](/help/communities/sites-console.md#user-management)。
