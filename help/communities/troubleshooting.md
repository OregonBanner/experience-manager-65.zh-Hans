...
# 社区故障诊断 {#troubleshooting}

本节包含社区疑难解答时的常见问题和已知问题。
...
非法模式字符“a”无法将请求提供给 `/content/demoforums/forum-test.html` 在此服务器上，日志包含以下内容：
...
此警告可以安全地忽略，因为 `jknack.handlebars.Handlebars`，使用者 [SCF](scf.md#handlebarsjavascripttemplatinglanguage)，随其自身的i18n帮助程序实用程序一起提供。 在启动时，它将被替换为特定于AEM的 [i18n助手](handlebars-helpers.md#i-n). 此警告由第三方库生成，用于确认覆盖现有帮助程序。
