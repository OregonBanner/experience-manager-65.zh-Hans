...
1. 只需视图[作者实例](http://localhost:4502/content/community-components/en/comments.html)上的评论（可能仍以admin/admin身份登录）。
   ...
   注意：作者&#x200B;*asipath*&#x200B;下有JCR节点，但这些节点用于SCF框架。 实际的UGC不在JCR中，而在MongoDB中。

1. 视图mongodb **[!UICONTROL Communities]** > **[!UICONTROL Collections]** > **[!UICONTROL Content]**&#x200B;中的UGC
