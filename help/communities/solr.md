...
1. 如果在创建集合时*未提供配置名称，则[将此新创建的集合](#link-a-collection-to-a-configuration-set)与上载到ZooKeeper的配置链接起来。
...
1. 准备新配置：
   ...
   1. 将提取的&#x200B;**stopwords/**&#x200B;文件夹复制到&#x200B;*new-config-dir*，生成`new-config-dir/stopwords/*.txt`
...
1. [创建一](#create-a-collection) 个集合，指定必要的参数，如分片数、副本数和配置名称。
1. 如果在创建集合时未提供配置名&#x200B;**，则[将此新创建的集合与上传到ZooKeeper的配置关联。](#link-a-collection-to-a-configuration-set)
