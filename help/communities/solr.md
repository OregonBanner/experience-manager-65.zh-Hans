...
An [Apache Solr](https://solr.apache.org/) 安装可以在以下用户之间共享： [节点存储](../../help/sites-deploying/data-store-config.md) (Oak)和 [公用存储](working-with-srp.md) (SRP)。
...
1. 对于MSRP，运行 [MSRP重新索引工具](msrp.md#msrp-reindex-tool)，除非此安装是新的。
...
1. 重新启动Solr。
1. 对于MSRP，运行 [MSRP重新索引工具](#msrpreindextool)，除非此安装是新的。
...
* 安装脚本在安装新版本之前通过附加“.orig”来备份schema.xml和solrconfig.xml
