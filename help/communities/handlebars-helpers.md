...
* **mode**:字符串
   ...
   （可选）要测试的 [WCM模式列表](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) （以逗号分隔）。
...
将渲染：&lt;ul>&lt;li>&lt;a href=&quot;/people/1&quot;>Alan&lt;/a>&lt;/li>&lt;a href=&quot;/people/2&quot;>Yehuda&lt;/a>&lt;/li>
...
要在服务器端实现和注册自定义SCF帮助程序，只需实现Java接口 [TemplateHelper](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/handlebars/api/TemplateHelper.html)，将它作为 [OSGi服务](../../help/sites-developing/the-basics.md#osgi) ，并作为OSGi捆绑的一部分进行安装。
