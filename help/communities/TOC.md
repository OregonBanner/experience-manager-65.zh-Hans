...
+ 管理 {#administer}
   ...
   + [Communities控制台](consoles.md)
   + [适用于社区功能的Analytics配置](analytics.md)
...
+ 开发 {#develop}
   ...
   + [Assignations Essentials](essentials-assignments.md)
   ...
   + [适用于Communities组件的OSGi事件](events.md)
   ...
   + [消息传送Essentials](essentials-messaging.md)
   + [问题与解答要点](qna-essentials.md)
   + [Rating Essentials](rating-basics.md)
   + [审查Essentials](reviews-basics.md)
   + [富文本编辑器Essentials](rte.md)
