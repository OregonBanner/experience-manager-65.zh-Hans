...
AEM Communities功能要求网站访客成为成员并登录 [社区站点](overview.md#communitiessites) 才能发布内容。 因此， [社区站点模板](sites.md)，社区站点从中为 [已创建](sites-console.md)，旨在包含登录功能以及用户配置文件、消息传送、搜索、审核和翻译。

社区站点将支持成员创建社区组，当 [社区组功能](functions.md#groups-function) 包含在选定的社区站点模板中。
