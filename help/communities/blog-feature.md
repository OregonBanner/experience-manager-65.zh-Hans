...
* [关联审核和批量审核](/help/communities/moderate-ugc.md) 博客文章和评论
...
当 [所需的客户端库](/help/communities/blog-developer-basics.md#essentials-for-client-side) 包含，这是 `Blog` 组件将显示：
...
在 **标记字段** 选项卡，指定在 **允许标记** 是检查 **设置** 选项卡：
...
当登录用户具有审核者或管理员权限时，他们能够执行 [审核任务](/help/communities/moderate-ugc.md) （由组件配置允许），在发布到博客的所有博客文章和评论中。

![审查方主页](assets/moderator-homepage.png)

#### 成员 {#members}

当登录用户是社区成员或 [特权成员](/help/communities/users.md#privileged-members-group) （具体取决于配置），用户可以选择 `New Article` 创建和发布新的博客文章。
...
有关 [博客要点](/help/communities/blog-developer-basics.md) 页面。
