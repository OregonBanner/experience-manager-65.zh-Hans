...
* **[!UICONTROL 删除审阅]**
   ...
   如果选中，则向发布审阅的成员提供删除该审阅的功能。 默认为未选中。

* **[!UICONTROL 拒绝审阅]**

   如果选中，则允许版主拒绝审阅。 默认为未选中。

* **[!UICONTROL 关闭／重新打开审阅]**

   如果选中，则允许版主关闭并重新打开审阅。 默认为未选中。

* **[!UICONTROL 标记审阅]**

   如果选中，允许成员将审阅标记为不合适。 默认为未选中。

* **[!UICONTROL 标志原因列表]**

   如果选中，允许成员从下拉式列表中选择其标记为不适当的原因。 默认为未选中。

* **[!UICONTROL 自定义标志原因]**

   如果选中，允许成员输入自己将审阅标记为不适当的原因。 默认为未选中。

* **[!UICONTROL 审核阈值]**

   输入成员在通知审核者之前必须标记审阅的次数。 默认值为一次(1)。
