...
* **支持使用字面选项设置JSON类型变量的值**：可在AEM Workflow的“设置变量”步骤中使用字面选项设置JSON类型变量的值。 通过字面选项，可按字符串的形式指定JSON。
...
* 当网页的链接由自定义servlet过滤器捆绑包等修改时，无法呈现网页。 (NPR-36857) &lt;! — 根据CQDOC-19203于2022年4月7日更新的注释 — >
...
* 在中显示字符的延迟 [!UICONTROL 数据] 选项卡以及HTML信件预览(NPR-37020)。
