...
>由Oracle分发的AdobeJava™技术的使用权限将于2022年12月底之前过期。 [!DNL Experience Manager] 我们鼓励客户规划和实施 [!DNL Azul Zulu] 此日期之前最新的JDK。 有关 [!DNL Oracle Java™] 技术和 [!DNL Azul Zulu] 技术，请参阅 [常见问题解答](https://experienceleague.adobe.com/docs/experience-manager-65/assets/Java_Policy_for_Adobe_Experience_Manager.pdf).
