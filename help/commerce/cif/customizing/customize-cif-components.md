...
查看的功能 **新建** 已在产品Teaser中实施的徽章。 尝试添加额外的复选框以便作者控制何时 **环保** 应显示徽章。 必须在以下位置更新组件对话框： `ui.apps/src/main/content/jcr_root/apps/venia/components/commerce/productteaser/_cq_dialog/.content.xml`.
