...
1. 选择资产或文件夹，然后单击工 **[!UICONTROL 具栏]**![中的删](assets/do-not-localize/deleteoutline.png) 除选项。
...
>[!NOTE]
>
>在“收 [藏集](/help/assets/manage-collections.md#navigating-the-collections-console)”控制台中， **[!UICONTROL “显示全部]** ”列表提供选项，仅用于视图注释和工作流。 此外，时间轴仅对控制台中列出的顶级集合显示。 如果您在任何集合中导航，则不会显示该集合。
...
1. 执行下列操作之一：
   ...
   * 要打印特定注释和审阅状态，请打 [开时](/help/assets/manage-assets.md#timeline) 间轴，然后转到步骤3。
...
1. 下 ![载PDF的](assets/do-not-localize/download.png) “下 ![载”选项或使用右上](assets/do-not-localize/print.png) 方的选项在PDF上打印PDF的打印选项。
   ...
   要修改呈现的PDF文件的外观，例如注释和状态的字体颜色、大小和样式、背景颜色，请从Configuration Manager **[!UICONTROL 中打开]** “注释PDF”配置，并修改所需的选项。 例如，要更改批准状态的显示颜色，请修改相应字段中的颜色代码。 有关更改批注的字体颜色的信息，请参阅 [批注](/help/assets/manage-assets.md#annotating)。
