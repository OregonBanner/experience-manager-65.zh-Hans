...
1. [预览混合媒体集](#previewing-mixed-media-sets).
   ...
   选择混合媒体集，然后您可以预览它。 选择缩略图图标，以便在选定的查看器中检查混合媒体集。 您可以从中选择不同的查看器 **[!UICONTROL 查看器]** 菜单，可从左边栏下拉菜单中访问。
...
您可以直接在用户界面中对混合媒体集中的资产执行各种编辑任务 [与Assets中的任何资产一样](/help/assets/manage-assets.md). 您也可以在混合媒体集中执行以下操作：
