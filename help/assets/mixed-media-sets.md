...
1. [上传资产](#uploading-assets).
   ...
   请参阅 [Dynamic Media — 支持的栅格图像格式](/help/assets/assets-formats.md#supported-raster-image-formats-dynamic-media) ，以获取混合媒体集支持的格式列表。

1. [创建混合媒体集](#creating-mixed-media-sets).

   要创建混合媒体集，请从资产页面中，选择 **[!UICONTROL 创建]** > **[!UICONTROL 混合媒体集]** 然后命名该集，选择资产，然后选择图像的显示顺序。
...
1. [预览混合媒体集](#previewing-mixed-media-sets).
   ...
   选择混合媒体集，之后您便可以进行预览。选择缩略图图标，以便在选定的查看器中检查混合媒体集。 您可以从 **[!UICONTROL 查看器]** 菜单（可从左边栏下拉菜单中访问）。
...
1. [将 URL 关联到您的 Web 应用程序](/help/assets/linking-urls-to-yourwebapplication.md)或者[嵌入视频查看器或图像查看器](/help/assets/embed-code.md)。
   ...
   请参阅 [将混合媒体集关联到网页](/help/assets/linking-urls-to-yourwebapplication.md) 和 [嵌入视频查看器或图像查看器](/help/assets/embed-code.md).

如有必要，您可以编辑 [混合媒体集](#editing-mixed-media-sets). 此外，您还可以查看和修改 [混合媒体集属性](/help/assets/manage-assets.md#editing-properties).

>[!NOTE]
>
>如果您在创建集时遇到问题，请参阅 [Dynamic Media - Scene7模式故障诊断](/help/assets/troubleshoot-dms7.md).
...
1. 在资产中，导航到要创建混合媒体集的位置，然后选择 **[!UICONTROL 创建]**，然后选择 **[!UICONTROL 混合媒体集]**. 您还可以从包含资产的文件夹中创建旋转集。此时将显示混合媒体集编辑器。

   ![chlimage_1-138](assets/chlimage_1-349.png)

1. 在混合媒体集编辑器中， **[!UICONTROL 标题]**，输入混合媒体集的名称。 该名称会显示在混合媒体集的横幅中。（可选）输入说明。
...
1. 选择资产选择器，以便您能够选择要包含在混合媒体集中的资产。 选择它们，然后选择 **[!UICONTROL 选择]**.
   ...
   借助资产选择器，您可以通过键入关键字并点按&#x200B;**[!UICONTROL 返回]**&#x200B;来搜索资产。您还可以应用过滤器来优化搜索结果。您可以按路径、收藏集、文件类型和标记进行过滤。选择过滤器，然后选择 **[!UICONTROL 过滤器]** 图标。 选择&#x200B;**[!UICONTROL 视图]**&#x200B;图标，然后选择&#x200B;**[!UICONTROL 列表视图]**、**[!UICONTROL 列视图]**&#x200B;或&#x200B;**[!UICONTROL 卡片视图]**&#x200B;以更改视图。

   请参阅 [使用选择器](/help/assets/working-with-selectors.md).

   ![chlimage_1-140](assets/chlimage_1-383.png)

1. 通过向上或向下拖动资产来重新排序资产(必须选择 **[!UICONTROL 重新排序]** 图标)。

   ![chlimage_1-141](assets/chlimage_1-352.png)

   如果要添加缩略图，请选择 **+** **[!UICONTROL 缩略图]** 图标，然后导航到所需的缩略图。 选择完所有缩略图后，选择 **[!UICONTROL 保存]**.
...
您可以直接在用户界面中对混合媒体集中的资产执行各种编辑任务 [与在资产中](/help/assets/manage-assets.md). 您还可以在混合媒体集中执行下列操作：
...
1. 执行以下任一操作：
   ...
   * 将鼠标悬停在混合媒体集资产上，选择 **[!UICONTROL 选择]** （复选标记图标），然后选择 **[!UICONTROL 编辑]** 中。

   * 选择混合媒体集资产，然后选择 **[!UICONTROL 编辑]** （铅笔图标）。

1. 在混合媒体集编辑器中，执行以下任一操作：

   * 要对资产重新排序 — 在左侧面板中，选择 **[!UICONTROL 资产]** （图片图标），将资产拖动到新位置。
   * 添加资产 — 在工具栏中，选择 **[!UICONTROL 添加资产]**. 导航到资产。 对于要添加的每个资产，将鼠标悬停在资产的图像（而非资产名称）上，然后选择复选标记图标。 在右上角，选择 **[!UICONTROL 选择]**.

   * 删除资产 — 在左侧面板中，选择 **[!UICONTROL 资产]** （图片图标），然后选择资产。 在工具栏中，选择 **[!UICONTROL 删除资产]**.

   * 要按资产名称的升序或降序排序，请在左侧面板中，选择 **[!UICONTROL 资产]** （图片图标）。 在 **[!UICONTROL 资产]** 标题中，选择向上或向下尖角图标。

      >[!NOTE]
      >
      >* 要从任何查看模式(例如 **[!UICONTROL 卡片视图]** 或 **[!UICONTROL 列视图]**)导航到混合媒体集。 将鼠标悬停在资产上，然后选择复选标记图标，以便您选择它。 按 **[!UICONTROL Backspace]** ，或选择 **[!UICONTROL 更多]** （三个圆点），然后选择 **[!UICONTROL 删除]**.
      >
      >* 您可以通过导航到混合媒体集并单击 **[!UICONTROL 设置成员]** 中。 选择 **[!UICONTROL 铅笔]** 图标，以便您在编辑窗口中将其打开。
...
1. 选择 **[!UICONTROL 保存]** 完成编辑后。
   ...
   >
   >* 要删除整个混合媒体集 — 从任何查看模式（如“卡片”视图或“列”视图）中，导航到混合媒体集。 将鼠标悬停在集上，然后选择 **选择** （复选标记图标）。 按 **[!UICONTROL Backspace]** 键盘上，或选择 **[!UICONTROL 更多]** （三个圆点的行），然后选择 **[!UICONTROL 删除]**.


## 预览混合媒体集 {#previewing-mixed-media-sets}

请参阅 [预览资产](/help/assets/previewing-assets.md) 以了解有关如何预览混合媒体集的详细信息。

## 发布混合媒体集 {#publishing-mixed-media-sets}

请参阅 [发布资产](/help/assets/publishing-dynamicmedia-assets.md) 以了解有关如何发布混合媒体集的详细信息。
