...
1. 在页面左上角附近的下拉列表中，单击&#x200B;**[!UICONTROL 时间轴。]**
...
1. Scene7:重新处理资产工作流页面，在右上角附近，单击&#x200B;**[!UICONTROL 编辑]**&#x200B;以“解锁”工作流。
1. 在工作流中，选择“Scene7批量上传”组件以打开工具栏，然后单击工具栏上的&#x200B;**[!UICONTROL 配置]**。
...
1. 在Scene7的右上角：重新处理资产工作流模型页，单击&#x200B;**[!UICONTROL 同步]**。 当您看到&#x200B;**[!UICONTROL 已同步]**&#x200B;时，工作流运行时模型已成功同步，并可以重新处理文件夹中的资产。
