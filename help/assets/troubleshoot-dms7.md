...
* 首先，安装了任何Adobe Experience Manager 6.4累积修补程序包(CFP) *之前* 任何可用的Dynamic Media功能包。
* 已安装可选功能包18912。
  ...
  <tr>
   ...
   <td><p>要确定视频编码是否仍在进行中或是否已进入失败状态，请执行以下操作：</p>
    <ul>
     ...
     <li>从工作流控制台中监控视频 <code>https://localhost:4502/libs/cq/workflow/content/console.html</code> &gt;实例、存档、失败选项卡。</li>
    </ul> </td>
   <td> </td>
  </tr>
  <tr>
