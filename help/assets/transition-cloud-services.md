...
[!DNL Adobe Experience Manager] 允许您使用所选翻译提供商提供的基于云的翻译服务，以确保根据您的要求对资产进行翻译。
...
1. 从 [!DNL Assets] 用户界面中，选择要将翻译服务应用到的文件夹。
...
1. 在工具栏中，单击 **[!UICONTROL 保存]**，然后单击 **[!UICONTROL 确定]** 关闭对话框。翻译服务将应用于文件夹。
...
1. 单击 **[!UICONTROL 立即配置]** 用于打开的链接 **[!UICONTROL 创建配置]** 对话框。
