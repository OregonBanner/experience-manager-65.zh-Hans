...
| AEM 6.5 | 本文 |
| AEM 6.4 | [单击此处](https://experienceleague.adobe.com/docs/experience-manager-64/assets/managing/private-folder.html?lang=en) |
...
1. 您向用户共享文件夹时，用户会收到共享通知。登录到 [!DNL Assets] 具有用于查看通知的用户凭据。
