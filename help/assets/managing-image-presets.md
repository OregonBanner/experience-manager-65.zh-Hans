...
DAM更新资产工作流中媒体提取流程组件参数 [!UICONTROL 中的ExtendScript路径] 。
...
1. 点按Dynamic **[!UICONTROL Media Process图像资产]** ，然后点按或单击缩 **[!UICONTROL 略图]** 选项卡。 Change the thumbnail size, as needed, then tap **[!UICONTROL OK.]**
