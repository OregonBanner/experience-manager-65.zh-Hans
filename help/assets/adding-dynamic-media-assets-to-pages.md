...
1. 拖动要使用的&#x200B;**[!UICONTROL Dynamic Media]**&#x200B;组件，并将其放到页面上的所需位置。
...
>[!NOTE]
>
>默认情况下，Dynamic media图像组件是自适应的。 如果要使其具有固定大小，请在&#x200B;**[!UICONTROL 高级]**&#x200B;选项卡的组件中，使用&#x200B;**[!UICONTROL 宽度]**&#x200B;和&#x200B;**[!UICONTROL 高度设置它。]**
