...
* 如果您的网站不在AEM上，您可以选择以下任一方式：
   ...
   * 如果您的站点是响应式的，则可以投 [放优化的图像。](/help/assets/responsive-site.md)
...
* [在Dynamic Media中激活热链接保护](https://helpx.adobe.com/experience-manager/6-4/help/assets/hotlink-protection.html)
...
* I验 [证您的CDN缓存内容](/help/assets/invalidate-cdn-cached-content.md)
