...
1. 在页面的右上角附近，从&#x200B;**[!UICONTROL 查看]**&#x200B;下拉列表中，点按&#x200B;**[!UICONTROL 卡片视图。]**
1. 导航到要查看的 3D 资产。
1. 点按3D资产的卡片。
...
Dynamic Media包含Dynamic Media 3D媒体组件，您可以在AEM Sites中使用该组件，以在网页上实现3D模型的交互式查看。
...
1. 打开AEM Sites，然后选择要将Dynamic Media 3D媒体组件添加到的网页。
1. 点按&#x200B;**[!UICONTROL 编辑]**（铅笔）图标，以在页面编辑器中打开页面。 确保在页面右上方附近选择了&#x200B;**[!UICONTROL 编辑]**&#x200B;模式。
...
1. 在AEM Sites页面编辑器中，选择您之前添加到页面的&#x200B;**[!UICONTROL 3D媒体查看器]**&#x200B;组件。
...
1. 在AEM Sites页面编辑器中，单击&#x200B;**[!UICONTROL Assets]**&#x200B;图标以打开侧面板中的&#x200B;**[!UICONTROL Assets]**。
...
>[!NOTE]
>
>当网页处于AEM Sites **[!UICONTROL 编辑]**&#x200B;模式时，3D媒体组件会显示3D资产，但无法与资产进行交互。 要使资产具有交互性，您可以使用&#x200B;**[!UICONTROL 预览]**&#x200B;功能在页面编辑器中查看网页，并完全访问3D媒体组件的功能。
...
1. 打开3D资产（GLB、OBJ或STL文件格式），以在资产详细信息页面中查看资产。
