...
查看器是各种设置或&#x200B;*预设的集合，例如查看器的显示大小、缩放行为、颜色方案、边框和字体。*&#x200B;这些预设决定了用户在其计算机屏幕和移动设备上查看富媒体资产的方式。
...
>[!NOTE]
>
>当您位于Adobe Experience Manager的网页（站点）上时，无法在&#x200B;**编辑**&#x200B;模式下预览资产。 单击页面右上角的&#x200B;**[!UICONTROL 预览]**，以转到预览模式。

要在用户界面中启用或禁用查看器预设，请参阅[管理查看器预设](/help/assets/managing-viewer-presets.md)。

**要使用软件界面预览资产，请执行以下操作：**

1. 从&#x200B;**[!UICONTROL Adobe Experience Manager]**&#x200B;的&#x200B;**[!UICONTROL 导航]**&#x200B;页面上，选择&#x200B;**[!UICONTROL Assets]**，然后选择&#x200B;**[!UICONTROL Files]**&#x200B;以访问资产。
1. 在页面的右上角附近，从&#x200B;**[!UICONTROL 视图]**&#x200B;下拉列表中，选择&#x200B;**[!UICONTROL 列表视图]**。
...
1. 根据您单击的资产类型，执行以下任一操作：
   ...
   <table>
    <tbody>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>查看器</strong>，然后选择维查看器。</li>
      <li>如果要将图像恢复为原始缩放，请选择<strong>Reset</strong>。</li>
      <li>选择<strong>全屏</strong>以最大化显示设备上的查看器。</li>
      </ul>
      <p><strong>导航3D场景</strong></p>
      <ul>
      <li><p><strong>旋转3D相机</strong>  — 围绕3D场景和对象绕行视图。</p> 鼠标：左键单击并拖动 </p> 触摸屏：按+拖动</p></li>
      <li><p><strong>平移相机</strong>  — 向左、向右、向上和向下平移视图。</p> 鼠标：右键单击并拖动 </p> 触摸屏：双指按+拖动</p></li>
      <li><p><strong>缩放相机</strong>  — 缩放相机，以便您可以在3D场景中移入和移出区域。</p> 鼠标：滚轮 </p> 触摸屏：手指捏</p></li>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>演绎版</strong>，然后选择要预览的特定演绎版。</li>
      </ul> <p><strong>在特定查看器中预览资产</strong></p>
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>查看器</strong>，然后选择要应用于资产的查看器。</li>
      </ul> <p>使用<strong>+</strong>和<strong>-</strong>图标可分别增加或减少所选图像的缩放比例。 如果要将图像恢复为原始缩放，请选择<strong>Reset</strong>。<br /> 如果您在触屏上，请双击图像以逐步放大。当您达到最大缩放比例时，再连按两次图像可重置缩放状态。横向拖动图像可进行平移。
</p> </td>
      </tr>
      <tr>
      <td>多媒体</td>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>演绎版</strong>，然后选择要预览的特定演绎版。</li>
      </ul> <p>选择要预览的高分辨率视频演绎版可能会导致视频显示被截断。 此问题是因为演绎版预览在用于预览的嵌入式查看器上下文中，向您显示客户将看到所有内容的确切分辨率。</p> <p>在资产级别预览自适应视频集时，演绎版会分组为一个播放体验。 也就是说，自适应视频的大小适合于观看，并且在观看设备和连接速度的上下文中使用最佳分辨率进行回放。<br /> </p> <p><strong>在特定查看器中预览资产</strong></p>
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>查看器</strong>，然后选择要应用于资产的查看器。</li>
      </ul> </td>
      </tr>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标以显示下拉列表。 从列表中选择<strong>查看器</strong>，然后选择要应用于资产的查看器。</li>
      </ul> <p>使用<strong>+</strong>和<strong>-</strong>图标，可分别增加或减少选定图像的缩放比例。 如果要将图像恢复为原始缩放，请选择<strong>Reset</strong>。<br /> 如果您在触屏上，请双击图像以逐步放大。当您达到最大缩放比例时，再连按两次图像可重置缩放状态。横向拖动图像可进行平移。
</p> </td>
      </tr>
      <tr>
      <td>旋转集</td>
