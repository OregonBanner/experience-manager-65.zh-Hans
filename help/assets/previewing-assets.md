...
您可以使用“预览”来查看客户在自己的Web浏览器中查看您上传的数字资产时的外观。 预览时将使用为资产分配的默认嵌入式跨设备查看器。

查看器是各种设置的集合，或者 *预设*，例如查看器显示大小、缩放行为、颜色方案、边框和字体。 这些预设确定用户在其计算机屏幕和移动设备上查看富媒体资产的方式。
...
>[!NOTE]
>
>当您位于Adobe Experience Manager的网页（站点）上时，无法预览以下位置的资源： **编辑** 模式。 通过单击转到预览模式 **[!UICONTROL 预览]** 在页面的右上角。

要在用户界面中启用或禁用查看器预设，请参阅 [管理查看器预设](/help/assets/managing-viewer-presets.md).

**要使用软件界面预览资产，请执行以下操作：**

1. 起始日期 **[!UICONTROL Adobe Experience Manager]**，位于 **[!UICONTROL 导航]** 页面，选择 **[!UICONTROL 资产]**，则 **[!UICONTROL 文件]** 以访问资产。
...
1. 根据您单击的资源类型，执行以下任一操作：
   ...
   <table>
    <tbody>
      ...
      <td><strong>能否在查看器中预览资源？</strong></td>
      <td> </td>
      </tr>
      <tr>
      <td><p>3D</p> </td>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标，此时将显示下拉列表。 选择 <strong>演绎版 </strong>从列表中，选择要预览的特定演绎版。</li>
      </ul> <p><strong>要在特定查看器中预览资源，请执行以下操作</strong></p>
      <ul>
      <li>在页面的左上角附近，单击图标，此时将显示下拉列表。 选择 <strong>查看器</strong> 从列表中，选择要应用于资源的查看器。</li>
      </ul> <p>使用 <strong>+</strong> 和 <strong>-</strong> 图标分别增大或减小所选图像的缩放比例。 选择 <strong>重置</strong> 如果要将图像恢复为原始缩放，请执行以下操作。<br /> 如果您在触摸屏上，请双击图像以按步骤放大。 当您达到最大缩放比例时，再连按两次图像可重置缩放状态。横向拖动图像可进行平移。
</p> </td>
      </tr>
      <tr>
      <td>多媒体</td>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标，此时将显示下拉列表。 选择 <strong>演绎版 </strong>从列表中，选择要预览的特定演绎版。</li>
      </ul> <p>选择要预览的更高分辨率视频演绎版可能会导致视频显示被截断。 此问题是因为演绎版预览会在用于预览的嵌入式查看器的上下文中显示客户将看到的全部的确切分辨率。</p> <p>在资源级别预览自适应视频集时，演绎版将分组到一个播放体验中。 也就是说，根据查看设备和连接速度，自适应视频经过适当的调整以适合查看和使用最佳分辨率回放。<br /> </p> <p><strong>要在特定查看器中预览资源，请执行以下操作</strong></p>
      <ul>
      <li>在页面的左上角附近，单击图标，此时将显示下拉列表。 选择 <strong>查看器</strong> 从列表中，选择要应用于资源的查看器。</li>
      </ul> </td>
      </tr>
      ...
      <ul>
      <li>在页面的左上角附近，单击图标，此时将显示下拉列表。 选择 <strong>查看器</strong> 从列表中，选择要应用于资源的查看器。</li>
      </ul> <p>使用 <strong>+</strong> 和 <strong>-</strong> 图标，以便您分别增大或减小所选图像的缩放。 选择 <strong>重置</strong> 如果要将图像恢复为原始缩放，请执行以下操作。<br /> 如果您在触摸屏上，请双击图像以按步骤放大。 当您达到最大缩放比例时，再连按两次图像可重置缩放状态。横向拖动图像可进行平移。
</p> </td>
      </tr>
      <tr>
      <td>旋转集</td>
...
1. 从Assets用户界面中，导航到包含要预览的资源的文件夹。
