...
另请参阅[组织数字资产以使用处理用户档案的最佳实践](/help/assets/organize-assets.md)。
...
要对视频使用智能裁剪，可创建自适应或渐进式视频编码用户档案。 在用户档案中，使用&#x200B;**[!UICONTROL 智能裁剪比率]**&#x200B;工具选择预定义的长宽比。 例如，在定义视频编码预设后，您可以添加长宽比为16x9的“移动横向”定义和长宽比为9x16的“移动纵向”定义。 您可以选择的其他长宽比或裁剪比包括1x1、4x3和4x5。
...
但是，如果该预定义的配置文件不符合您的需求，您也可以选择自行创建自适应视频编码配置文件。当您将自适应流播放的设置&#x200B;**[!UICONTROL 编码]**&#x200B;用作最佳实践时，将验证您添加到用户档案的所有编码预设，以确保所有视频具有相同的宽高比。 此外，编码的视频会被视为流播放的多比特率集。
...
1. 输入配置文件的名称和描述。
1. 在“创建／编辑视频编码预设”页面，点按&#x200B;**[!UICONTROL 添加视频编码预设。]**
...
1. 执行下列操作之一：
   ...
   * 要帮助您可视化视频的大小，请点按&#x200B;**[!UICONTROL Height]**&#x200B;右侧的“信息”图标(i)以打开“大小计算器”页。 使用&#x200B;**[!UICONTROL 大小计算器]**&#x200B;设置所需的视频尺寸（由蓝框表示）。 完成后，点按右上角的 **[!UICONTROL X]**。
...
1. （可选）要向将应用此用户档案的视频添加视频智能裁剪，请执行以下操作：
   * 在“编辑视频”用户档案页面的“智能裁剪比率”标题的右侧，点按&#x200B;**[!UICONTROL 添加新。]**
...
要帮助您可视化视频的大小，请点按“高度”的信息图标以打开**[!UICONTROL 大小计算器]**&#x200B;页。 使用“**[!UICONTROL 大小计算器]**”页面，根据需要进一步设置视频尺寸（蓝框）。 完成后，在对话框的右上角，点按&#x200B;**[!UICONTROL X.]**
1. （可选）执行以下操作之一：
...
1. 在CRXDE Lite页的左上角，点按&#x200B;**[!UICONTROL 返回主页]**&#x200B;图标以返回AEM。

### 编辑视频用户档案{#editing-a-video-encoding-profile}

您可以编辑已创建的任何视频用户档案，以在该用户档案中添加、编辑或删除视频预设。

默认情况下，您无法编辑Dynamic Media附带的预定义现成&#x200B;**[!UICONTROL 自适应视频编码]**&#x200B;用户档案。 相反，您可以轻松复制用户档案并用新名称保存它。 然后，您可以在复制的用户档案中编辑所需的预设。
...
1. 作为最佳实践，请确保选中“自 **[!UICONTROL 适应流播放的编码]** ”复选框。 点按信息图标以获取自适应流播放的说明。 （如果要复制渐进式视频配置文件，请勿选中此复选框。）
   ...
   在Dynamic Media —— 混合模式中，如果WebM视频预设是视频用户档案的一部分，则无法对自适应流播放进行&#x200B;**[!UICONTROL 编码，因为所有预设都必须是MP4。]**
1. 在“视频编码预设”标题下，添加、编辑或删除构成该配置文件的视频编码预设。
...
#### 通过用户档案用户界面{#applying-video-profiles-to-folders-by-way-of-the-profiles-user-interface}将视频用户档案应用到文件夹
...
1. 点按或单击AEM徽标，然后导航到&#x200B;**[!UICONTROL 资产]**，然后导航到要应用视频用户档案的文件夹。
...
您可 [以监视视频用户档案处理作业的进度](#monitoring-the-progress-of-an-encoding-job)。
...
### 通过用户档案用户界面{#removing-video-profiles-from-folders-by-way-of-the-profiles-user-interface}将视频用户档案从文件夹删除
