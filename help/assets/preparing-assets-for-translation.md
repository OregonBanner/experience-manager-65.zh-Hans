...
在 [!DNL Adobe Experience Manager Assets]，则多语言资产会包含在文件夹中，其中每个文件夹都包含使用不同语言的资产。
...
1. 创建语言主目录的语言根目录。 例如，示例文件夹层次结构中英语副本的语言根目录为 `/content/dam/en`. 确保根据 [创建语言根](preparing-assets-for-translation.md#creating-a-language-root).
...
1. 从 [!DNL Assets] 控制台，单击 **[!UICONTROL 创建]** 选择 **[!UICONTROL 文件夹]** 中。

   ![创建文件夹](assets/Create-folder.png)

1. 在 **[!UICONTROL 名称]** 字段，请使用 `<language-code>`.

   ![在文件夹中添加语言代码](assets/Add-language-code-in-folder.png)

1. 单击&#x200B;**[!UICONTROL 创建]**。将在 [!DNL Assets] 控制台。

## 查看语言根 {#viewing-language-roots}

[!DNL Experience Manager] 界面提供 **[!UICONTROL 引用]** 面板，显示在中创建的语言根列表 [!DNL Assets].

1. 在 [!DNL Assets] 控制台中，选择要为其创建语言副本的语言主目录。
1. 从左边栏中，选择 **[!UICONTROL 引用]** 选项 [!UICONTROL 参考] 中。

   ![chlimage_1-122](assets/chlimage_1-122.png)

1. 在引用窗格中，单击 **[!UICONTROL 语言副本]**. 的 [!UICONTROL 语言副本] 面板会显示资产的语言副本。
