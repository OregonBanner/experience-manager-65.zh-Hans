...
1. 选择图像，然后点按工具 **[!UICONTROL 栏中的]** “管理标记”。
1. 从“管 **[!UICONTROL 理标记]** ”页面检查标记。 如果不希望根据特定标记搜索图像，请选择该标记，然后点按工具栏中的 **[!UICONTROL 删除]** 。 或者，单击／点 `X` 按标签旁边显示的符号。
1. 要为标记指定更高的等级，请选择标记，然后点按工 **[!UICONTROL 具栏]** 中的提升。 您提升的标记将移到“标记 **[!UICONTROL ”部分]** 。
