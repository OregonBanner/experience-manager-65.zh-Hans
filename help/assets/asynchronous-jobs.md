...
1. 点按／单击AEM徽标，然后转到“操 **[!UICONTROL 作]** ”> **[!UICONTROL “作业”]**。
...
1. 要停止活动操作，请从列表中选择该操作，然后点按 **[!UICONTROL 工具栏]** 中的停止。

   ![stop_icon](assets/stop_icon.png)

1. 要查看其他详细信息（例如说明和日志），请选择操作，然后点按工 **[!UICONTROL 具栏]** 中的打开。
...
1. 要从列表中删除操作，请从工具栏 **[!UICONTROL 中选择]** “删除”。 要下载CSV文件中的详细信息，请点按下 **[!UICONTROL 载]**。
