...
所列成果消耗了相当多的资源。 因此，如果不需要回写，Adobe建议禁用XMP。 有关更多信息，请参阅 [XMP写回](https://experienceleague.adobe.com/docs/experience-manager-64/assets/administer/xmp-writeback.html).
