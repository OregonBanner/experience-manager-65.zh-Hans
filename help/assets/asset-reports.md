...
1. 在[!DNL Experience Manager]接口中，单击&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL 资产]** > **[!UICONTROL 报表]**。
   ...
   ![“工具”页，用于导航资产报表](assets/AssetsReportNavigation.png)
...
* 如果报表中的某些报表或数字不可用或无法按预期，请确保[!UICONTROL Day CQ DAM事件记录器]服务已启用。

* 删除不再需要的报表。 使用DAM报表清除服务中的配置选项配置要清除报表的标准。

* 如果磁盘使用情况报告未生成且您正在使用[!DNL Dynamic Media]，请确保所有资产都正确继续。 要解析资产，请重新处理资产，然后再次生成报表。
