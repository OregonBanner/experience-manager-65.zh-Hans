...
从&#x200B;**[!UICONTROL 详细信息视图>查看器查看资产时，AEM会显示各种查看器预设。]** 您可以增加或减少显示的查看器数量。
...
1. 在&#x200B;**[!UICONTROL 新建查看器预设]**&#x200B;对话框的&#x200B;**[!UICONTROL 预设名称]**&#x200B;字段中，输入新预设的名称。请仔细选择名称 — 在您点按&#x200B;**[!UICONTROL 创建后，这些名称将不可编辑。]**
...
|  | **描述** | **操作** |
|---|---|---|
| **[!UICONTROL 热点图标]** | 更改用于热点的图标 | 要更改热点图标图像，请在&#x200B;**[!UICONTROL 外观]**&#x200B;选项卡的&#x200B;**[!UICONTROL 选定组件]**&#x200B;中，点按&#x200B;**[!UICONTROL ImageMapEffect。]** 在“ **[!UICONTROL 图标]**”下，选 **** 择“背景”，然 **** 后在“图像”字段中导航到所需的背景图像。 |
...
1. 点按AEM左上角的AEM徽标，然后点按左边栏中的&#x200B;**[!UICONTROL 工具]**（锤子图标）**[!UICONTROL >资产>查看器预设。]**
...
1. 打开资产并在页面左上角附近，点按下拉菜单，然后选择&#x200B;**[!UICONTROL 查看器。]**
