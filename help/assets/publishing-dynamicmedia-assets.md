...
您可以通过选择已上传的资产并点按来发布Dynamic Media资产 **[!UICONTROL 发布]** 或 **[!UICONTROL 快速发布]**. 发布Dynamic Media资产后，您便可以通过URL或在页面上嵌入代码，将这些资产包含在网页中。

您还可以立即发布上传的资产，无需任何用户干预。 请参阅 [配置Dynamic Media - Scene7模式](config-dms7.md).
或者，您也可以使用 **[!UICONTROL 选择性发布]** 在文件夹级别。 请参阅 [在Dynamic Media中使用“选择性发布”功能](/help/assets/selective-publishing.md).
