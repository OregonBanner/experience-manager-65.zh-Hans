...
或者，您也可以在文件夹级别使用选择性发布，将资产有选择地发布到Dynamic Media **[!UICONTROL 或AEM(彼此互斥]** )。 请参 [阅在Dynamic Media中使用选择性发布。](/help/assets/selective-publishing.md)
...
有关发布集或资产的详细信息，请参阅发 [布资产。](manage-assets.md)
