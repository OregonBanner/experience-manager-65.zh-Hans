---
title: Adobe Experience Manager6.5资产用户指南
seo-title: Adobe Experience Manager6.5资产用户指南
...
# Adobe Experience Manager6.5资产用户指南
...
## Experience Manager6.5用户指南

| 用户指南 | 描述 |
|--- |---|
| [发行说明](/help/release-notes/home.md) | 提供有关最新版本的重要信息，包括新增的、受支持的平台、已弃用和已删除的功能以及已知问题 |
| [表单用户指南](/help/forms/home.md) | 本指南介绍如何创建、管理、发布和更新数字表单。 |
| [社区用户指南](/help/communities/home.md) | 创建在线体验，如论坛、用户组、学习资源和其他社交功能。 |
| [管理指南](/help/sites-administering/home.md) | 了解如何管理Experience Manager。 |
| [创作指南](/help/sites-authoring/home.md) | 本指南介绍了在Experience Manager中进行创作的概念。 |
| [经典UI创作指南](/help/sites-classic-ui-authoring/home.md) | 本指南介绍在经典用户界面中以Experience Manager进行创作的概念。 |
...
| [部署用户指南](/help/sites-deploying/home.md) | 本指南向您展示Experience Manager的基础知识。 |
...
| [Experience Manager Livefyre](https://docs.adobe.com/content/help/en/livefyre/using/home.html) | 本指南向您展示如何与用户生成的内容共享 [!DNL Livefyre]。 |

## 关键Experience Manager资源

* [Experience Manager视频教程](https://helpx.adobe.com/experience-manager/kt/index/aem-6-5-videos.html#Assets)
