...
* 视频跟踪支持仅限于“核心播放”跟踪，如 [跟踪概述](https://experienceleague.adobe.com/docs/media-analytics/using/sdk-implement/track-av-playback/track-core-overview.html#player-events). 尤其是，不支持QoS、广告、章节/区段或错误跟踪。
...
请参阅 [通过将Experience Manager与Experience Platform标记集成 [!DNL Adobe I/O]](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/overview.html) 有关设置Experience Platform标记云配置的更多信息。
