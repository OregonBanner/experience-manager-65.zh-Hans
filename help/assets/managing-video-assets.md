...
了解如何在Adobe Experience Manager资产中管理和编辑视频资产。 此外，如果您获得使用Dynamic Media的许可，请参阅Dynamic [Media视频文档](/help/assets/video.md)。

## 上传和预览视频资产 {#upload-and-preview-video-assets}

Adobe Experience Manager Assets为扩展名为MP4的视频资产生成预览。如果资产格式不是MP4，请安装FFmpeg包以生成预览。 FFmpeg创建OGG和MP4类型的视频演绎版。 您可以在“资产”用户界面中预览这些演绎版。
...
>[!NOTE]
>
>Experience Manager Classic用户界面没有2 GB文件大小限制。 此外，大型视频的端对端工作流程不完全受支持。
...
1. 在Experience Manager中，单击 **[!UICONTROL 工具]** > **[!UICONTROL 操作]** > **** Web Console。
...
1. 单击&#x200B;**[!UICONTROL 保存]**。
1. 在Experience Manager中，单击工 **[!UICONTROL 具]** >工 **[!UICONTROL 作流]** > **[!UICONTROL 模型]**。
