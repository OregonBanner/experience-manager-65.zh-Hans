...
[变体](/help/assets/content-fragments.md#constituent-parts-of-a-content-fragment) 是内容片段的重要功能，因为它们允许您创建和编辑主内容的副本，以用于特定渠道和／或场景。
...
* [总结文本](#summarizing-text)
* [注释](/help/assets/content-fragments-variations.md#annotating-a-content-fragment) 您的文本
...
>[!NOTE]
>
>有关完整信息，请参 [阅标记](/help/assets/content-fragments-markdown.md) 文档。
...
* 可以在选定片段的时间轴 [中查](/help/assets/content-fragments-managing.md#timeline-for-content-fragments) 看和删除该片段。
