...
1. 从工 **[!UICONTROL 具栏中点]** “发布”。 如果工具栏中未显示 **发布** ，请点按工具栏中的 **[!UICONTROL 更多]** ，然后找到发布 **[!UICONTROL 选项]** 。
...
1. 在资产UI中，选择资产，然后点按属 **[!UICONTROL 性]** ，以显示其资产详细信息页面。
...
1. 要根据资产的状态搜索资产，请点按搜 **[!UICONTROL 索]** ，以显示Omnisearch栏。
...
如果您选择受保护的资产并点按下 **[!UICONTROL 载]**，则会将您重定向到接受许可协议的许可页面。 如果您不接受许可协议，则禁用“ **[!UICONTROL 下载]** ”按钮。

如果选择包含多个受保护的资产，则一次选择一个资产，接受许可协议，然后继续下载资产。
