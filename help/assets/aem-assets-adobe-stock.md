...
>[!NOTE]
>
>如果有多个[!DNL Adobe Stock]配置，请在“[!UICONTROL 用户首选项]”面板中选择所需的配置。 要从[!DNL Experience Manager]主页访问面板，请单击用户图标，然后单击&#x200B;**[!UICONTROL 用户首选项]** > **[!UICONTROL Stock配置]**。
...
![在搜索结果中搜 [!DNL Experience Manager] 索资产并 [!DNL Adobe Stock] 突出显示资产过滤器](assets/aem-search-filters2.jpg)
...
>[!MORELIKETHIS]
>
>* [有关使用资 [!DNL Adobe Stock] 源的视频教程 [!DNL Experience Manager Assets]](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-stock.html)
