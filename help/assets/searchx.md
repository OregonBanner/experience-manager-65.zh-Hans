...
>[!CAUTION]
>
>截至 [!DNL Experience Manager] 6.4，已弃用经典UI。 有关公告，请参阅 [已弃用和已删除的功能](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/deprecated-removed-features.html). Adobe建议使用触屏优化UI。 有关自定义信息，请参阅 [搜索Facet](/help/assets/search-facets.md).
...
| showFlatOption | 布尔值 | 用于显示复选框的标记 `search in subfolders`. 默认设置为 true。 |
