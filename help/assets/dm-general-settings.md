...
另请参阅 [可选 — 设置和配置Dynamic Media - Scene7模式设置](/help/assets/option-b-config-dms7.md#optional-setup-and-configuration-of-dynamic-media-scene7-mode-settings) fpr更多可选配置任务。
