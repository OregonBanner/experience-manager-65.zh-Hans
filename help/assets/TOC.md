...
+ [[!DNL Experience Manager] 6.5资产发行说明](https://docs.adobe.com/content/help/en/experience-manager-65/release-notes/assets.html)
+ [关于DAM](assets.md)
...
+ 扩展资产 {#extending}
   ...
   + [扩展搜索功能](searchx.md)
   + [安装和配 [!DNL ImageMagick] 置可与 [!DNL Assets]](best-practices-for-imagemagick.md)
