...
+ Dynamic Media{#dynamic}
   + [按Experience League分类的新闻稿存档](dynamic-media-newsletter.md)
...
+ 扩展资产 {#extending}
   ...
   + [持久查询](content-fragments/persisted-queries.md)
...
+ 管理资产 {#administer}
   ...
   + [资源中的Digital Rights Management](drm.md)
   + [使用演示包进行资产分析](use-demo-package-for-asset-insights.md)
   + [配置Adobe资源链接](configure-asset-link.md)
   + [为Adobe InDesign生成FPO演绎版](configure-fpo-renditions.md)
