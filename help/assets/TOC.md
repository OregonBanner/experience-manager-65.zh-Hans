...
+ Dynamic Media{#dynamic}
   ...
   + [Dynamic Media视频配置文件](video-profiles.md)
...
+ 品牌门户 {#brandportal}
   + [配置与Brand Portal的集成](brand-portal-configuring-integration.md)
