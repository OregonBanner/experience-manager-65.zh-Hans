...
仅当您 *not* 使用Adobe Experience Manager作为WCM。 如果您使用Experience Manager作为WCM， [您可以直接在页面上添加资产](adding-dynamic-media-assets-to-pages.md).
...
1. 选择 **[!UICONTROL 嵌入]**.
1. 在 **[!UICONTROL 嵌入代码]** ，将整个代码复制到剪贴板，然后选择 **[!UICONTROL 关闭]**.
1. 将嵌入代码粘贴到网页中。
