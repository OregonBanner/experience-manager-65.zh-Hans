...
只有在满足以下条件时才嵌入URL： *非* 将Adobe Experience Manager用作WCM。 如果您使用Experience Manager作为WCM， [直接在页面上添加资产](adding-dynamic-media-assets-to-pages.md).
...
>[!NOTE]
>
>只有在发布选定的资产后，才可复制其嵌入代码。此外，还必须发布查看器预设或图像预设。
>
