...
>[!NOTE]
>
>本文档介绍了直接集成到Dynamic Media中的Adobe Experience Manager功能。 如果您使用集成到Experience Manager中的Dynamic Media Classic，请参阅[Dynamic Media Classic集成文档](/help/sites-administering/scene7.md)。
>
>有关要将与Dynamic Media Classic集成的Experience Manager与Dynamic Media一起使用的时间，请参阅[双重使用方案](/help/sites-administering/scene7.md#dual-use-scenario)。
