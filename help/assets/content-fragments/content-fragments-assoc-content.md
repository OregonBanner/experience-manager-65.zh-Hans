...
AEM关联内容功能提供了连接，以便在将资产添加到内容页面时，可以选择将资产与片段一起使用。 这样，您就可以灵活地通过 [提供在页面上使用内容片段时要访问的资产范围，](/help/sites-authoring/content-fragments.md#using-associated-content) 同时有助于缩短搜索相应资产所需的时间。
