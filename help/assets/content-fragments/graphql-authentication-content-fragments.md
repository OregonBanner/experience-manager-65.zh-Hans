...
的主要用例 [用于内容片段投放的Adobe Experience Manager (AEM) GraphQL API](/help/assets/content-fragments/graphql-api-content-fragments.md) 是接受来自第三方应用程序或服务的远程查询。 这些远程查询可能需要经过身份验证的 API 访问，以保护 Headless 内容投放。
