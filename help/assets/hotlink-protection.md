...
[Experience Manager客户支持](https://experienceleague.adobe.com/?support-solution=Experience+Manager#support) 可以在CDN（内容交付网络）级别配置反向链接过滤器，以便仅将Dynamic Media内容提供给域允许网站列表上的网站。
