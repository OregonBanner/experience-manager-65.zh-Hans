...
此 **管理应用程序** 图块和“管理应用程序”页面提供了一种查看和编辑应用程序元数据的方法。 将应用程序发布到供应商的存储时需要应用程序元数据的详细信息。 这可能包括常用元数据、iOS元数据和屏幕截图。 请参阅 [管理应用程序磁贴](/help/mobile/phonegap-app-details-tile.md) 以了解有关常用和iOS元数据的更多详细信息。
...
1. 要查看或编辑详细信息，请单击 **管理应用程序** 图块。

1. 在如下图所示的五个可用选项卡的任何一个中输入或查看详细信息。

   ![chlimage_1-30](assets/chlimage_1-30.png)

## 编辑公共和IOS元数据 {#editing-common-and-ios-metadata}
...
## 添加和删除屏幕快照 {#add-and-remove-screenshots}

您可以将应用程序屏幕截图包含到元数据汇总中。 有些供应商在将任何应用程序提交到其应用商店时，需要准确的屏幕截图。 这些图像必须已存在于资产中。 参见 [资产选取器](../assets/search-assets.md#assetpicker) 以上传您的屏幕截图。
