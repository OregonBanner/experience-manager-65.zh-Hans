...
* **请求API密钥**：要访问On-Demand Services API，您需要请求API密钥。 要请求API密钥，请完成 [PDF表单](https://helpx.adobe.com/digital-publishing-solution/help/aem-mobile-end-of-life-faq.html). 将填写好的表单发送到Adobe Developer支持： [wwds@adobe.com](mailto:wwds@adobe.com)
...
>[!NOTE]
>
>应授予所需的Adobe ID对AEM Mobile项目的访问权限。 参见 [AEM Mobile帐户管理](https://helpx.adobe.com/digital-publishing-solution/help/aem-mobile-end-of-life-faq.html) 在线帮助中。
