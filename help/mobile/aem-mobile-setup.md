...
>[!CAUTION]
>
>从AEM 6.2或6.3迁移到AEM 6.5的现有AEM Mobile应用程序客户可以通过从PackageShare下载包来继续使用AEM Mobile应用程序。 但是，新安装的AEM 6.5将不支持AEM Mobile应用程序功能。
...
* **请求API密钥**:要访问On-Demand Services API，您需要请求API密钥。 要请求API密钥，请完成 [PDF表单](https://helpx.adobe.com/digital-publishing-solution/help/aem-mobile-end-of-life-faq.html). 将填写好的表单发送给Adobe Developer支持： [wwds@adobe.com](mailto:wwds@adobe.com)
...
>[!NOTE]
>
>需要的Adobe ID应授予对AEM Mobile项目的访问权限。 请参阅 [AEM Mobile帐户管理](https://helpx.adobe.com/digital-publishing-solution/help/aem-mobile-end-of-life-faq.html) 中。
