...
传递安全文档时，请使用单点登录并指定具有“文档上传应用程序用户”角色 *的AEM表单用户* 。 如果没有此角色，用户将无法上传安全文档。 您可以以编程方式为用户分配角色。 (请参阅 [管理角色和权限](/help/forms/developing/users.md#managing-roles-and-permissions)。)
...
此快速入门包含一个名为 *bank.css的样式表*。 以下代码表示所使用的样式表。
