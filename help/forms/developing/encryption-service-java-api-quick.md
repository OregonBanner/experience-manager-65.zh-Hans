...
description: 加密服务Java API QuickStart(SOAP)
...
以下Java代码示例从名为EncryptLoan.pdf的PDF文档中删除基于口 *令的加密*。 用于删除基于密码的加密的主控密码值为 *PermissionPassword*。 无保护的PDF文档将另存为名为noEncryptionLoan. *pdf的PDF文件*。 (请参 [阅删除密码](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-password-encryption)。)
...
以下Java代码示例从名为EncryptLoanCert.pdf的PDF文档中删除基 *于证书的加密*。 用于删除加密的公钥的别名为 `Encryption`。 无保护的PDF文档将另存为名为noEncryptionLoan. *pdf的PDF文件*。 (请参阅 [删除基于证书的加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-certificate-based-encryption)。)
