---
title: 加密服务Java API快速启动(SOAP)
description: 在SOAP模式下使用Java API加密、删除基于密码/证书的加密、解锁和确定PDF文档的加密类型。
...
[快速启动（SOAP模式）：使用Java API删除基于密码的加密](encryption-service-java-api-quick.md#quick-start-soap-mode-removing-password-based-encryption-using-the-java-api)
...
[快速启动（SOAP模式）：使用Java API删除基于证书的加密](encryption-service-java-api-quick.md#quick-start-soap-mode-removing-certificate-based-encryption-using-the-java-api)
...
[快速启动（SOAP模式）：使用Java API确定加密类型](encryption-service-java-api-quick.md#quick-start-soap-mode-determining-encryption-type-using-the-java-api)

AEM Forms操作可以使用AEM Forms强类型API执行，并且连接模式应设置为SOAP。

>[!NOTE]
>
>“使用AEM进行编程”表单中的“快速入门”基于在JBoss Application Server和Microsoft Windows操作系统上部署的Forms Server。 但是，如果您使用的是其他操作系统（如UNIX），请将特定于Windows的路径替换为适用的操作系统支持的路径。 同样，如果您使用的是其他J2EE应用程序服务器，请确保指定有效的连接属性。 请参阅 [设置连接属性](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties).

## 快速入门（SOAP模式）：使用Java API加密PDF文档 {#quick-start-soap-mode-encrypting-a-pdf-document-using-the-java-api}

以下Java代码示例加密一个名为的PDF文档 *Loan.pdf* 密码值为 `OpenPassword`. 主密码为 `PermissionPassword`. 受保护的PDF文档将保存为名为的PDF文件 *EncryptLoan.pdf*. (请参阅 [使用密码加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-a-password).)
...
## 快速启动（SOAP模式）：使用Java API删除基于密码的加密 {#quick-start-soap-mode-removing-password-based-encryption-using-the-java-api}

以下Java代码示例从名为的PDF文档中删除基于密码的加密 *EncryptLoan.pdf*. 用于删除基于密码的加密的主密码值为 *Permissionpassword*. 不安全的PDF文档将另存为名为的PDF文件 *noEncryptionLoan.pdf*. (请参阅 [删除密码加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-password-encryption).)
...
以下Java代码示例加密一个名为的PDF文档 *Loan.pdf* 具有名为的证书 *Encryption.cer*. 加密的PDF文档保存为名为的PDF文件 *EncryptLoanCert.pdf*. (请参阅 [使用证书加密PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#encrypting-pdf-documents-with-certificates).)
...
## 快速启动（SOAP模式）：使用Java API删除基于证书的加密 {#quick-start-soap-mode-removing-certificate-based-encryption-using-the-java-api}

以下Java代码示例从名为的PDF文档中删除基于证书的加密 *EncryptLoanCert.pdf*. 用于删除加密的公共密钥的别名是 `Encryption`. 不安全的PDF文档将另存为名为的PDF文件 *noEncryptionLoan.pdf*. (请参阅 [删除基于证书的加密](/help/forms/developing/encrypting-decrypting-pdf-documents.md#removing-certificate-based-encryption).)
...
以下Java代码示例解锁一个密码加密的PDF文档，名为 *EncryptLoan.pdf*. (请参阅 [解锁加密的PDF文档](/help/forms/developing/encrypting-decrypting-pdf-documents.md#unlocking-encrypted-pdf-documents).)
