...
description: Distiller服务Java API快速入门(SOAP)
...
以下代码示例将转换名为 *Loan.ps* 到名为的PDF文件 *Loan.pdf*. (请参阅 [将PostScript转换为PDF文档](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents).)
