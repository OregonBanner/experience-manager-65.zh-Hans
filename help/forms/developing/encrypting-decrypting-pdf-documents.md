...
您必须获取未加密的PDF文档，才能使用密码对文档进行加密。 如果试图保护已加密的PDF文档，则会导致异常。
...
您必须获取要加密的未加密PDF文档。 如果尝试保护已加密的PDF文档，则会引发异常。
...
必须获取已加密的PDF文档，才能删除基于密码的加密。 如果尝试从未加密的PDF文档中删除加密，则会引发异常。
...
必须获取加密的PDF文档才能将其解锁。 如果尝试解锁未加密的PDF文档，则会引发异常。
