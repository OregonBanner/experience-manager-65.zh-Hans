...
您必须检索受策略保护的PDF文档才能撤销它。 您无法撤销已撤销或不是受策略保护文档的文档。

如果您知道受策略保护文档的license identifier值，则不必检索受策略保护的PDF文档。 但是，在大多数情况下，您需要检索PDF文档以获取许可证标识符值。
...
必须检索已撤销PDF文档的许可证标识符才能恢复已撤销PDF文档。 获取许可证标识符值后，您可以恢复已撤消的文档。 如果尝试恢复未撤消的文档，则会导致异常。
...
必须检索受策略保护的Word文档才能删除策略。 如果尝试从不受策略保护的Word文档中删除策略，则会导致异常。
