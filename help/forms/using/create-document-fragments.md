...
如[创建表单数据模型](../../forms/using/create-form-data-model0.md)部分所述，请使用&#x200B;**FDM_Create_First_IC**&#x200B;作为表单数据模型，以在本教程中创建文档片段。
...
1. 将光标放在&#x200B;**备用联系人号码**&#x200B;字段旁边，多次单击** customer** > **alternatemobilenumber**&#x200B;属性。
...
1. 使用右侧窗格为以下字段创建静态文本：
   ...
   * 到期日后的延迟付款费用为$ 20
   ...
   ![帐单汇总静态文本](assets/bill_summary_static_new.png)
