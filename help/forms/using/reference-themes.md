...
[主题](../../forms/using/themes.md) 让您能够在不了解CSS的情况下为表单设置样式。 除了默认主题之外，您还可以通过安装 [AEM Forms附加组件包](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=en)：
...
执行主题可避免使用纯背景填充来强调表单元件。 选择并单击组件会更改字体颜色。 与默认画布主题相比，所选选项卡中文本的字体颜色会更改为深蓝色。 请注意导航和提交按钮与Beryl主题有何不同。
...
Exec Light主题使用空格创建无缝体验。 “下一个”和“提交”按钮获得实心填充和3D阴影。 左侧的选定选项卡将获得一个箭头，而不是双复选标记。
...
“自由”主题使用极简主义方法来强调重要意义。 例如，已访问选项卡的字体颜色会更改为绿色。 您只能看到文本框的底部轮廓，该文本框模拟带有线条的纸制表单的外观。 活动文本框的底部轮廓为黑色，而其他文本框的底部轮廓为浅灰色。
