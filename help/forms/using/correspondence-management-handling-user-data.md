...
>[!NOTE]
>
>在AEM 6.5Forms，无法开箱即用地进行通信管理。 如果您是从以前的AEM Forms版本升级，请安装兼容性包并迁移您的通信管理资产，以继续在AEM 6.5Forms中使用它们。 有关详细信息，请参阅[兼容性软件包](/help/forms/using/compatibility-package.md)。
