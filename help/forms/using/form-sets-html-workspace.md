...
表单集是HTML5个表单的集合，分组后以一组表单的形式呈现给最终用户。 当最终用户开始填写表单集时，他们会从一个表单无缝地转换到另一个表单。 然后，只需单击一次即可提交一组表单。 有关表单集及其设置方法的详细信息，请参阅 [表单集在AEM Forms](../../forms/using/formset-in-aem-forms.md).
