...
1. 导航到[!UICONTROL CRXDE Lite]中的/etc/clientlibs。 右键单击/etc/clientlibs子文件夹，然后单击&#x200B;**[!UICONTROL 创建]** > **[!UICONTROL 创建节点]**。 在&#x200B;**[!UICONTROL 名称]**&#x200B;字段类型&#x200B;**WeRetailFormTestCases**&#x200B;中。 选择类型&#x200B;**cq:ClientLibraryFolder**，然后单击&#x200B;**[!UICONTROL 确定]**。 它创建一个节点。 可以使用任何名称代替`WeRetailFormTestCases`。
...
1. 打开AEM Testing UI(AEM > **[!UICONTROL 工具]** > **[!UICONTROL 操作]** > **[!UICONTROL 测试]**)。 测试套件- **We retail - Tests** —— 列在UI中。
...
1. 在[!UICONTROL CRXDE lite]中，导览至`/content/forms/af/create-first-adaptive-form`文件夹。 右键单击&#x200B;**[!UICONTROL create-first-adaptive-form]**&#x200B;文件夹节点，然后单击&#x200B;**[!UICONTROL 创建]****[!UICONTROL 创建文件]**。 在&#x200B;**[!UICONTROL 名称]**&#x200B;字段中，键入`prefill.xml`并单击&#x200B;**[!UICONTROL 确定]**。 将以下代码添加到文件：
...
1. 导航至 `/etc/clientlibs`. 右键单击`/etc/clientlibs`子文件夹，然后单击&#x200B;**[!UICONTROL 创建]****[!UICONTROL 创建节点]**。
   ...
   在&#x200B;**[!UICONTROL 名称]**&#x200B;字段类型`WeRetailFormTests`中。 选择类型`cq:ClientLibraryFolder`，然后单击&#x200B;**[!UICONTROL 确定]**。
...
1. 在&#x200B;**[!UICONTROL WeRetailFormTests]**&#x200B;节点中创建一个文件`prefillTest.js`。 将以下代码添加到文件。 代码创建测试用例。 测试用例预填表单的所有字段并验证某些字段，以确保输入正确的值。
...
## 第3步：运行套件或单个测试用例中的所有测试{#step-run-all-the-tests-in-a-suite-or-individual-tests-cases}
...
1. 导航到AEM图标> **[!UICONTROL 工具]**> **[!UICONTROL 操作]**> **[!UICONTROL 测试]**
...
1. 要从测试套件运行单个测试，请执行以下操作：
   ...
   1. 点按&#x200B;**[!UICONTROL 预填测试]**&#x200B;并点按&#x200B;**[!UICONTROL 运行测试]**&#x200B;按钮。 测试执行时，屏幕右侧的空白区域将替换为自适应表单。

1. 点按测试名称“Prefill test”，查看测试用例的结果。 它打开[!UICONTROL Result]面板。 点按[!UICONTROL Result]面板中测试用例的名称，以视图测试的所有详细信息。
