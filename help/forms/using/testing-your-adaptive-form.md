...
1. 以管理员 [!DNL Forms] 身份登录到AEM作者实例。 打开 [!UICONTROL CRXDE Lite]。 您可以点按AEM徽标> **[!UICONTROL 工具]** >常 **[!UICONTROL 规]** > **[!UICONTROL CRXDE Lite]** ，或在浏 [览器中打](https://localhost:4502/crx/de/index.jsp) 开https://localhost:4502/crx/de/index.jspURL以打开CRXDE Lite。

1. 在CRXDE Lite中导航到/etc/clientlibs 。 右键单击/etc/clientlibs子文件夹，然后单击“ **[!UICONTROL 创建]** ”> **[!UICONTROL “创建节点]**”。 在“名 **[!UICONTROL 称]** ”字段 **中键入WeRetailFormTestCases**。 选择类型( **cq:ClientLibraryFolder** )，然后单 **[!UICONTROL 击“确定”]**。 它创建一个节点。 您可以使用任何名称代替 `WeRetailFormTestCases`。
1. 将以下属性添加到节 `WeRetailFormTestCases` 点并点按保 **[!UICONTROL 存全部]**。
...
1. 右键单击WeRetailFormTestCases **[!UICONTROL 节点]** ，单击 **[!UICONTROL 创建]** > **[!UICONTROL 创建文件]**。 在“名 **[!UICONTROL 称]** ”字段中，键 `js.txt` 入并单 **[!UICONTROL 击“确定]**”。
...
1. 打开AEM Testing UI(AEM > **[!UICONTROL Tools]** > **[!UICONTROL Operations]** > **[!UICONTROL Testing]**)。 UI中列出 **测试套件** - We retail - Tests。
...
1. 在 [!UICONTROL CRXDE lite中]，导览至该文 `/content/forms/af/create-first-adaptive-form` 件夹。 右键单击 **[!UICONTROL create-first-adaptive-form文件夹节点]** ，然后单击“ **[!UICONTROL 创建]**”>“ **[!UICONTROL 创建文件”]**。 在“名 **[!UICONTROL 称]** ”字段中，键 `prefill.xml` 入并单 **[!UICONTROL 击“确定]**”。 将以下代码添加到文件：
...
1. 要运行测试套件的所有测试，请执行以下操作：
   ...
   1. 在“Tests  （测试）”面 **[!UICONTROL 板中，点按We retail - Tests(1)]**。 它该套件扩展为显示测试列表。
...
1. 点按测试名称“Prefill test”，查看测试用例的结果。 它打开“结 [!UICONTROL 果] ”面板。 点按“结果”面板中测试用 [!UICONTROL 例的名] 称，以视图测试的所有详细信息。
