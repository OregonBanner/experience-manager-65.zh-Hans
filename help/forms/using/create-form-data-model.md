...
1. 安装JDBC驱动程序 [!DNL MySQL] 数据库作为OSGi包：
   ...
   1. 下载 [!DNL MySQL] JDBC驱动程序OSGi包从 `http://www.java2s.com/ref/jar/download-orgosgiservicejdbc100jar-file.html`. <!-- This URL is an insecure link but using https is not possible -->
