...
您可以使用主题为自适应表单提供独特的外观和样式。 您可以应用随自适应表单编辑器提供的开箱即用主题，也可以创建您自己的自定义主题。 AEM [!DNL Forms] 提供 [主题编辑器](https://helpx.adobe.com/experience-manager/6-3/forms/using/themes.html) 创建自定义主题。 单个主题可以为在移动设备、平板电脑或桌面上打开的同一自适应表单提供不同的外观。 使用主题编辑器不需要任何有关CSS或LESS的先前知识，但需要它。
...
1. 的打开属性 **[!UICONTROL 自适应表单容器]**. 在属性浏览器中，导航到 **[!UICONTROL 基本]** > **[!UICONTROL 自适应表单主题]**. 的 **[!UICONTROL 自适应表单主题]** 字段中列出了所有现成主题和自定义主题。 默认情况下，将应用画布主题。
1. 从 **[!UICONTROL 自适应表单主题]** 字段。 例如， **调查主题**. 点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) 以应用所选主题。
...
1. 更改标题的现有徽标和文本。 要删除徽标，请执行以下操作：
   ...
   1. 点按 [!UICONTROL 标题] 组件和点按 ![cppr](assets/cmppr.png) **[!UICONTROL 属性]**. 在 [!UICONTROL 图像] 属性中，点按X以删除现有徽标图像。
   1. 点按 **[!UICONTROL 上传]**，选择logo.png ，然后点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) 以保存更改。 图像已在 [开始之前](/help/forms/using/style-your-adaptive-form.md#before-you-start) 中。
   1. 点按标题文本， `We.Retail`，然后点按 ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL 编辑]**. 将标题文本更改为 `we retail`. 仅对应用粗体格式 `we`in `we retail`.
...
1. 删除标题并添加占位符文本：
   ...
   1. 复制 **[!UICONTROL 标题]** 字段 **[!UICONTROL 占位符文本]** 字段。
   1. 删除 **[!UICONTROL 标题]** 字段和点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 **[!UICONTROL 创建]** 选择 **[!UICONTROL 主题]**. 的 [!UICONTROL 创建主题] 页面中会显示创建主题所需的字段。 的 **[!UICONTROL 标题]** 和 **[!UICONTROL 名称]** 字段为必填字段：
...
1. 点按&#x200B;**[!UICONTROL 创建]**。随即会创建主题，并显示一个用于打开表单进行编辑的对话框。 点按 **[!UICONTROL 打开]** 在新选项卡中打开新创建的主题。 主题在主题编辑器中打开。 对于样式，主题编辑器使用AEM附带的现成自适应表单 [!DNL Forms].

   有关使用主题编辑器UI的信息，请参阅 [关于主题编辑器](/help/forms/using/themes.md#aboutthethemeeditor).

1. 点按 **[!UICONTROL 主题选项]** ![主题选项](assets/theme-options.png) > **[!UICONTROL 配置]**. 在 **[!UICONTROL 预览表单]** 字段，选择 **shipping-add-add-update-form** 自适应表单，点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)，点按 **[!UICONTROL 保存]**. 现在，主题编辑器配置为使用您自己的自适应表单，而不是默认的自适应表单。 点按 **[!UICONTROL 取消]** 返回主题编辑器。
...
1. 导航 **[!UICONTROL 标题]** > **[!UICONTROL 文本]** 选项。 “选择器”面板位于主题编辑器的左侧。 如果面板不可见，请点按 ![切换侧面板](assets/toggle-side-panel.png) 切换侧面板。

1. 在 **[!UICONTROL 文本]** 折叠面板和点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 [!UICONTROL 标题] 小组件和点按 **[!UICONTROL 标题]**. 用于设置标题小组件样式的选项将显示在左侧。 展开 **[!UICONTROL Dimension和位置]** 折叠面板，设置 **[!UICONTROL 高度]** to `120px`，然后点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
1. 展开 **[!UICONTROL 背景]** 标题小组件的折叠面板中，将 **[!UICONTROL 背景颜色]** to `F6921E.`
...
1. 在主题编辑器中，点按标题中的徽标，然后点按 **[!UICONTROL 标题徽标]**. 展开Dimension和位置折叠面板，设置以下属性并点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按页脚小组件，然后点按 **[!UICONTROL 页脚]**. 展开 **[!UICONTROL 背景]** 折叠面板，设置 **[!UICONTROL 背景颜色]** to `F6921E`，然后点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 **[!UICONTROL 客户ID]** 字段，然后点按 **[!UICONTROL 字段小组件]** 选项。 设置以下属性并点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 **[!UICONTROL 客户ID]** 字段和点按 **[!UICONTROL 响应式面板容器]**. 设置 **[!UICONTROL 背景]** > **[!UICONTROL 背景颜色]** 到F1F2F2。 点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 **[!UICONTROL 提交]** 按钮，然后点按 **[!UICONTROL 按钮]** 选项。 设置以下属性并点按 ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. 点按 **[!UICONTROL 附加]** 按钮，然后点按 ![aem_6_3_edit](assets/aem_6_3_edit.png)图标。 在 **[!UICONTROL Dimension和位置]** 折叠面板：
...
1. 点按 **[!UICONTROL 提交]** 按钮，然后点按 ![aem_6_3_edit](assets/aem_6_3_edit.png) 图标。 设置以下属性：
...
[!DNL Adobe Fonts] 是web字体服务。 您可以对自适应表单配置并使用该服务。 使用 [!DNL Adobe Fonts] 在自适应表单中：
...
1. 创建 [Adobe Fonts](https://typekit.com/) 帐户、创建工具包、将字体Myriad Pro添加到工具包、发布工具包并获取工具包ID。 需要使用 [!DNL Adobe Fonts] （Web字体）。
1. 在AEM中 [!DNL Forms] 服务器，导航到 ![adobeexperiencemanager](assets/adobeexperiencemanager.png) **[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL 工具]** ![锤子](assets/hammer.png) > **[!UICONTROL Adobe Fonts]**. 现在，打开配置文件夹。 如果配置已可用，请单击 **[!UICONTROL 创建]** 按钮以创建新实例。

   在创建配置对话框中，指定 **标题** ，然后单击 **[!UICONTROL 创建]**. 系统会将您重定向到配置页面。 在 [!UICONTROL 编辑组件] 对话框，提供 **套件ID** 单击 **[!UICONTROL 确定]**.

1. 配置主题以使用 [!DNL Adobe Fonts] 配置。 在创作实例上，打开 **[!UICONTROL 全球主题]** 在主题编辑器中。 在主题编辑器中，导航到 **[!UICONTROL 主题选项]** ![主题选项](assets/theme-options.png) > **[!UICONTROL 配置]**. 在 **[!UICONTROL Adobe Fonts配置]** 字段，选择工具包，然后单击 **[!UICONTROL 保存]**.

   添加到 **[!UICONTROL Adobe Fonts]** 可供在 **[!UICONTROL 文本]** 折叠面板。
