...
1. 导航到 `/libs/fd/af/runtime/clientlibs/guideRuntime`嵌入属 `fp.validation` 性并附加该值。

1. 导航到/libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA并将值附 `fp.validation` 加到embed属性后。
