...
AEM Forms on OSGi和AEM Forms on JEE都具有工作流功能。 您可以在OSGi上的AEM表单上快速构建和部署各种任务的基本工作流，而无需在JEE上安装AEM Forms的完整流程管理功能。 在 [OSGi上AEM Forms上以表单为中心的工作流的特点及JEE上AEM Forms的流程管理功能](capabilities-osgi-jee-workflows.md). 在OSGi上开发和管理AEM Forms上以表单为中心的工作流时，会使用熟悉的AEM工作流和AEM收件箱功能。
