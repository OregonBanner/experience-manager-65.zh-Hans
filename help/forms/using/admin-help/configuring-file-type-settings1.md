...
**主OCRLanguage:** 用于OCR引擎的语言，用于标识字符。 默认值为英语（美国）。
...
“Adobe PDF导出设置”部分中的“导出文件类型”设置用于将PDF文件转换为其他格式。 默认为HTML 4.01，带有层叠样式表(CSS)1.0(&amp;ast;.htm,&amp;ast;.html)。
...
1. 如果只想嵌入嵌入字体的使用中子集，请选择“子集化所 **有嵌入字体”**。
   ...
   >[!NOTE]
   >
   >*如果您将此选项与取消嵌入某些字&#x200B;**体结合使用**，则“将字体&#x200B;****添加到取消嵌入”列表中的字体仍完全取消嵌入。*
...
这些选项决定了如何转换Microsoft PowerPoint文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings)。
...
这些选项决定如何转换AutoCAD文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings)。
...
这些选项决定如何转换OpenOffice文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings)。
