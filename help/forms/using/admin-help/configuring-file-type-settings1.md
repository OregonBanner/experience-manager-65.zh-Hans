...
“Adobe PDF导出设置”部分中的“导出文件类型”设置用于将PDF文件转换为其他格式。 默认为HTML 4.01，带有级联样式表(CSS)1.0(&amp;ast;.htm， &amp;ast;.html)。
...
1. 如果只想嵌入嵌入字体的在用子集，请选择&#x200B;**子集化所有嵌入字体**。
   ...
   >[!NOTE]
   >
   >*如果您将此选项与“取消嵌入”一起使&#x200B;**用**，则“将字体添加到取消嵌入”列&#x200B;****表中的字体仍将完全取消嵌入。*
...
这些选项决定了Microsoft PowerPoint文件的转换方式。 有关访问这些选项的说明，请参阅[创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings)。
