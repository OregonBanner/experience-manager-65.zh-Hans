...
**主要OCRL语言：** OCR引擎用于识别字符的语言。 默认为英语（美国）。
...
[其他应用程序的设置（仅限Windows）](#other-applications-settings-windows-only)
   ...
   要转到其他部分，请单击其网页上的链接，或使用**[!UICONTROL 下一个]**或 **[!UICONTROL 上一个]** 按钮。
...
Adobe PDF导出设置部分中的导出文件类型设置用于将PDF文件转换为其他格式。 默认为HTML4.01，带有级联样式表(CSS)1.0(&amp;ast;.htm， &amp;ast;.html)。
...
1. 如果只想嵌入嵌入字体的已使用子集，请选择 **对所有嵌入字体进行子集**.
   ...
   >[!NOTE]
   >
   >*如果您将此选项与&#x200B;**取消嵌入某些字体**，字体&#x200B;**A**将字体添加到取消嵌入列表仍完全取消嵌入。*
...
这些选项可确定如何转换Microsoft PowerPoint文件。 有关访问这些选项的说明，请参阅 [创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
这些选项可确定AutoCAD文件的转换方式。 有关访问这些选项的说明，请参阅 [创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
**[!UICONTROL 创建符合PDF/E-1规范的文件]**:创建符合PDF/E-1规范的文件。 PDF/E是用于交换工程和技术文档的ISO标准。 有关PDF/E-1的详细信息，请参阅 [Adobe和行业标准](https://www.adobe.com/enterprise/standards/index.html).
...
这些选项可确定OpenOffice文件的转换方式。 有关访问这些选项的说明，请参阅 [创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
