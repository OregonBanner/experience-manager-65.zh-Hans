...
>
>**client_idleTimeout：当** 用户在特定时间段内保持非活动状态时，AEM Forms工作区会话将过期。要启用该功能，请向全局设置&lt;client_idleTimeout>*IDLE_TIMEOUT_IN_SECONDS*&lt;/client_idleTimeout>添加一个条目。 您可以指定值0以禁用空闲超时。 时间以秒为单位指定。
