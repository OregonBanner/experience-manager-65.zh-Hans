...
1. 在 [AEM包共享](https://localhost:4502/crx/packageshare/login.html)**中，搜索AEM 6.5 Forms Add-on包或最**&#x200B;新的服务包&#x200B;**，单击适用于您的操作系统的包，然******&#x200B;后单击下载。 阅读并接受许可协议，然后单击 **确定**。 下载开始。 下载后，包旁 **会显** 示“已下载”一词。
