...
1. 您的计算机上现在安装了以下项目：
   ...
   * **设计人员**:您可以从Workbench中访问Designer。有关信息，请参阅<a href="https://helpx.adobe.com/content/dam/help/en/experience-manager/6-5/forms/pdf/using-designer.pdf">Designer Help</a>中的入门主题。
...
### 配置并登录服务器{#configuring-and-logging-server}
...
默认情况下，Workbench在两小时后超时，无论活动或不活动。 要编辑超时设置，请参阅<a href="https://docs.adobe.com/content/help/en/experience-manager-65/forms/administrator-help/configure-user-management/configure-advanced-system-attributes.html">管理控制台帮助</a>中的“配置用户管理>配置高级系统属性”。
