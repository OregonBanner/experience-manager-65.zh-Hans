...
1. 点按 **[!UICONTROL 启动/数据收集]** 并点击 **[!UICONTROL 转到Launch/数据收集]**.

1. 点按 **[!UICONTROL 新建属性]** 并指定配置的名称。

1. 指定域名并点击 **[!UICONTROL 保存]** 以保存资产。

1. 点按“标记属性”列表中可用的配置名称。

1. 在 **[!UICONTROL 创作]** 部分，点按 **[!UICONTROL 扩展]**.

1. 点按 **[!UICONTROL 目录]** 并点击 **[!UICONTROL 安装]** 对于 **[!UICONTROL Adobe Experience Manager Forms]** 扩展。 **[!UICONTROL Adobe Experience Manager Forms]** 会在中提供的已安装扩展列表中显示 **已安装** 选项卡。
...
1. 在 **[!UICONTROL 活动]** 部分，点按 **[!UICONTROL 添加]**.
...
1. 在 **[!UICONTROL Prop]** 部分，将下拉列表中可用的报表包选项映射到使用定义的数据元素 [配置数据元素](#configure-data-elements).
   ...
   1. 点按 **[!UICONTROL 添加其他]** 以向列表中添加更多数据元素。

1. 在 **[!UICONTROL 活动]** 部分，从报表包中可用的选项中选择一个事件，然后点击 **[!UICONTROL 保留更改]**.

1. 在 **[!UICONTROL 操作]** 部分，点按+并指定 **[!UICONTROL Adobe Analytics]** 作为扩展名称。

1. 选择 **[!UICONTROL 发送信标]** 作为操作类型。 在右窗格中，选择 **[!UICONTROL s.t()]** 以将数据发送到 [!DNL Adobe Analytics] 并将其视为页面查看或 **[!UICONTROL s.tl()]** 以将数据发送到 [!DNL Adobe Analytics] 并且不要将其视为页面查看。 点按 **[!UICONTROL 保留更改]**.
...
1. 点按 **[!UICONTROL 添加库]** 并指定名称，然后选择库的环境。

1. 点按 **[!UICONTROL 添加所有已更改资源]** 然后点击 **[!UICONTROL 保存并生成到开发环境]**.

1. 在 **[!UICONTROL 开发]** 部分，点按 ![更多选项](/help/forms/using/assets/more-options-icon.svg) 然后点击 **[!UICONTROL 批准并发布到生产环境]**.
...
1. 点按 ![可视化图表](/help/forms/using/assets/visualization-icon.svg) 并将图表类型拖放到“自由格式”部分。 同样，可以向自由格式部分添加多个图表类型。
