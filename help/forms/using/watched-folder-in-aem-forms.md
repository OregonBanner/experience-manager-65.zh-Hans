...
* 如果AEM Forms服务器在监视文件夹调用作业之前关闭，则管理员可以将文件移出舞台文件夹。 有关信息，请参 [阅故障点和恢复](../../forms/using/watched-folder-in-aem-forms.md#p-failure-points-and-recoveryfailure-points-and-recovery-p)。
* 如果AEM Forms服务器正在运行，但当作业管理器服务回调时(即服务未按顺序开始时)，监视文件夹未运行，则管理员可以将文件移出舞台文件夹。 有关信息，请参 [阅故障点和恢复](../../forms/using/watched-folder-in-aem-forms.md#p-failure-points-and-recoveryfailure-points-and-recovery-p)。
