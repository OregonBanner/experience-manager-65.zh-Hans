...
1. 以管理员身份登录AEM Web Console。 URL为https://&#39;[服务器]:[端口]“/system/console/configMgr
1. 打开移动Forms配置进行编辑。
...
引用XFA的自适应表单的字段与XFA中的可用字段绑定。 更新表单模板时，关联的自适应表单会尝试与XFA同步。 有关更多详细信息，请参阅 [将自适应表单与关联的XFA同步](../../forms/using/synchronizing-adaptive-forms-xfa.md).
