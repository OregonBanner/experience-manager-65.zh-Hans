...
1. **Adobe收件箱**:位于AEM后端的顶 [部菜单栏](assets/bell.svg) “铃”图标。
...
## 自动化Forms转化(Camila) {#automated-forms-conversion}

**本节**:CX潜在客户已有一个基于PDF的表单，该表单用作基于纸张的流程的一部分。 作为现代化努力的一部分，她希望使用此PDF表单自动创建新的现代自适应Forms。

### 自动化Forms转化- We.Gov(Camila) {#automated-forms-conversion-wegov}
...
1. Camila以在“自动Forms转化- We.Gov”中转 [换的表单打开“属性”](#automated-forms-conversion-wegov)。
...
1. 卡米拉单击 **输出文** 件夹，选择自适应表单， **然后单击“编** 辑”以打开完成的We.Gov表单。
1. Camila选择自适应表单字段并单击“ ![配置”图标](assets/configure-icon.svg)。 她使用“绑定引用”(Bind Reference)字段创建与表单数据模型 **实体的** 绑定。 她在自适应表单中对所有字段重复此步骤。
...
### Adobe Analytics站点报告（卡米拉） {#camila-reviews-sites-reporting-we-gov-adobe-analytics}
...
1. 从同一菜单中，选择“**视图设置**”，并从“分析”部分选择要显&#x200B;**示的列**。
...
1. 选择“健康&#x200B;**优势的注册申请**”自适应表单并选择“**分析报告**”选项。
