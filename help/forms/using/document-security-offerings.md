...
* **文档安全扩展，Microsoft Office**:您可以使用文档Security Extension for Microsoft Office从Microsoft Office项目内将预定义的策略应用于Microsoft Office文件。此扩展确保只有授权人员才能使用受策略保护的Microsoft Word、Excel和PowerPoint文件。 只有已安装该插件的授权用户才能使用受策略保护的文件。
   ...
   文档安全扩展可作为Microsoft Office插件使用。 您可以联系[AEM支持团队](https://helpx.adobe.com/ca/marketing-cloud/contact-support.html)来获取扩展。 稍后，您可以访问[文档安全扩展，以了解有关安装、配置和使用扩展的帮助。](https://helpx.adobe.com/aem-forms/aem-document-security/download-installer.html)
