...
中列出的一些API [GuideBridge](https://helpx.adobe.com/aem-forms/6/javascript-api/GuideBridge.html) 使用元素的SOM表达式。 例如，要以自适应形式将焦点放在特定字段，请将相应的SOM表达式传递到 `getFocus`中的API `guideBridge`.
