...
* [使用XML架构创建自适应表单](../../forms/using/adaptive-form-xml-schema-form-model.md)
...
OSGi上的AEM Forms提供以表单为中心的工作流，允许您构建基于表单的自适应工作流。 这些工作流可用于审阅和批准、业务流程流、启动文档服务、与Adobe sign签名工作流集成等。 有关详细信息，请参 [阅OSGi上以表单为中心的工作流程](../../forms/using/aem-forms-workflow.md)。
...
您可以访问位于https://&lt;*hostname*>:&lt;*PublishPort*>/content/we-finance/global/en.html的we.finance站点的AEM收件箱。 在页面中，点按 **登录**，选中以代表身份登录复选框 **，使用Gloria Rios的用户名／密码登录AEM收件箱**`grios/password` ，然后批准信用卡应用程序。 有关将AEM收件箱用于以表单为中心的工作流任务的信息，请参阅 [管理表单应用程序和AEM收件箱中的任务](../../forms/using/manage-applications-inbox.md)。
...
使用Adobe Analytics跟踪信用卡申请表的性能指标。 有关配置Adobe Analytics和查看报告的更多信息，请参 [阅配置表单和文档的分析](../../forms/using/configure-analytics-forms-documents.md)。

#### 亲身体验 {#see-it-yourself-br}

为便于您查看和浏览分析报告，我们在参考站点中为信用卡应用程序提供种子数据。 在使用种子数据之前，请参阅 [配置分析](../../forms/using/setup-reference-sites.md#configureanalytics)。 在创作实例中执行以下步骤以查看包含种子数据的报表：
...
要在AEM Forms服务器中配置Target，请参 [阅在AEM Forms中设置和集成Target](../../forms/using/ab-testing-adaptive-forms.md#set%20up%20and%20integrate%20target%20in%20aem%20forms)。
...
有关将AEM收件箱用于以表单为中心的工作流任务的信息，请参阅 [管理表单应用程序和AEM收件箱中的任务](../../forms/using/manage-applications-inbox.md)。
...
使用Adobe Analytics跟踪抵押申请表的绩效指标。 有关配置Adobe Analytics和查看报告的更多信息，请参 [阅配置表单和文档的分析](../../forms/using/configure-analytics-forms-documents.md)。

#### 亲身体验 {#see-it-yourself-br-1}

为了便于您查看和浏览分析报告，我们在参考站点中为按揭贷款应用程序提供了种子数据。 在使用种子数据之前，请参阅 [配置分析](../../forms/using/setup-reference-sites.md#configureanalytics)。 在创作实例中执行以下步骤以查看包含种子数据的报表：
...
当Sarah提交主页保险申请时，将触发一个Forms Workflow，并在Gloria的AEM收件箱中创建一个任务。 当Gloria审阅并批准该应用程序时，该任务将分配给Frank De Costa。 在与保险应用程序关联的AEM工作流中，可以定义从一个角色到另一个角色的任务流。 有关工作流程的更多信息，请参 [阅OSGi上以表单为中心的工作流程](../../forms/using/aem-forms-workflow.md)。
