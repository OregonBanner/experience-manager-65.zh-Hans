...
HTML5表单使用ARIA HTML5辅助工具标准生成可访问的HTML表单。 这些表单支持选项卡式导航（Mozilla FireFox除外），并经认证可与通用屏幕阅读器兼容。 要生成具有良好辅助功能的HTML5表单，请根据一些基本设计准则设计XFA表单模板。 设计准则包括配置正确的标签顺序并为每个表单控件提供演讲文本内容。 AEM Forms设计人员支持设置这些表单控件属性以生成可访问的PDF和HTML5表单。
