...
默认情况下，当非Adobe PDF查看器（如[!DNL Chrome]或[!DNL Firefox]中的默认PDF查看器）无法读取PDF/XFA表单的内容时，将显示“页面零”内容。 默认的“Page Zero（零页）”消息如下所示。

![defaultpage0message](assets/defaultpage0message.png)

[!DNL AEM Forms] Designer版本允许您更改在“Page Zero”（零页）上显示的消息。要更改“零页”消息，请执行以下步骤：
