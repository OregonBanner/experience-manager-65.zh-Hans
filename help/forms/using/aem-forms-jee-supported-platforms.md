...
<table>
 <tbody>
  ...
  <tr>
   <td><p>Red Hat Enterprise Linux 7（内核3.x）（64位）</td>
   <td><p>答：支持</p> </td>
...
>此外：
>
>* PDF生成器需要32位版本的[Acrobat 2017版本17.011.30078或更高版本](https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html)才能执行转换。
