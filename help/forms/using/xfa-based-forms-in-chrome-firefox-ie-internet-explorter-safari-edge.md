...
这样，您对XFA表单的技术投资就会得到保护，并继续为最终用户提供最佳体验。 有关更多信息，请参阅 [Adobe Experience Manager Forms产品文档](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/home.html).
