...
>[!NOTE]
>
>* 在AEM 6.4 Forms中，crx-repository的结构和路径已更改。 如果将资产从先前版本导入AEM 6.4表单，且表单对旧结构有某些依赖关系，则必须手动导出依赖关系。 有关存储库结构和路径更改的详细信息，请参阅AEM中 [的存储库重组](/help/sites-deploying/repository-restructuring.md)。
>
