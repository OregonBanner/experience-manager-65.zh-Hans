...
当用户提交表单时，浏览器将JSON格式的表单状态发送给提交服 [务代理](../../forms/using/service-proxy.md);然后，提交服务代理使用JSON数据生成数据XML，并提交该数据XML以提交端点。

## 组件 {#components}

您需要AEM Forms加载项包来启用HTML5表单。 有关安装AEM Forms加载项包的信息，请参 [阅安装和配置AEM Forms](../../forms/using/installing-configuring-aem-forms-osgi.md)。
...
要更新这些设置，请转至CQ FelixAdmin Console卡(位于[https://]&lt;&#39;[server]:port&#39;/system/console/configMgr)，搜索并选择“移动Forms配置”。
