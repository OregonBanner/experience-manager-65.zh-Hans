...
您可以使用汇编程序服务将两个或多个PDF文档组合成单个PDF文档或PDFPortfolio。 您还可以将有助于导航或增强安全性的功能应用于PDF文档。 以下是组合PDF文档的一些方法：
...
### 使用Bates编号来组合文档 {#assemble-documents-using-bates-numbering}
...
您可以使用汇编程序服务来拆解PDF文档。 该服务可以从源文档中提取页面或基于书签划分源文档。 通常，如果PDF文档最初是从许多单独的文档（如语句集合）中创建，则此任务会很有用。
...
您可以使用汇编程序服务来确定PDF文档是否符合PDF/A规范。 PDF/A是一种存档格式，用于长期保存文档的内容。 字体嵌入在文档中，且文件未压缩。 因此，PDF/A文档通常比标准PDF文档大。 此外，PDF/文档不包含音频和视频内容。
