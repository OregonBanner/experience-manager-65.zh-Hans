...
>[!NOTE]
>
>仅当您处于OSGI设置中，并且要实现的自定义类型需要LC集成时，才需要执行此步骤。
...
1. 单击“ **选择文件** ”，然后选择“SendLetterForReview.lca”。
...
1. 在“创建对应UI”中，单 **击“信函审阅** ”并指定审阅人的电子邮件ID。
