...
1. 右键单击以下路径中的&#x200B;**locale**&#x200B;文件夹，然后选择&#x200B;**粘贴**:
...
DSCSample.jar文件使用renderLetter API从C作为输入的XML数据将字母渲染为PDF字节。 有关renderLetter和其他API的详细信息，请参阅[Letter Render Service](https://helpx.adobe.com/aem-forms/6-2/javadocs/com/adobe/icc/ddg/api/LetterRenderService.html)。
...
1. 右键单击&#x200B;**RenderWrapper**&#x200B;并选择&#x200B;**开始组件**。 如果组件开始，则组件名称旁边将显示一个绿色箭头。
...
1. 在创建对应UI中，单击&#x200B;**信函审阅**&#x200B;并指定审阅人的电子邮件ID。
