...
1. 复制/apps分支下的acmExtensionsConfig.xml文件（位于/libs分支下）。
   ...
   1. 右键单击“/apps/fd/cm/config/defaultApp/”处的&#x200B;**defaultApp**&#x200B;文件夹，然后选择&#x200B;**粘贴**。
   1. 单击&#x200B;**保存全部**。
...
1. 右键单击以下路径的&#x200B;**locale**&#x200B;文件夹，然后选择&#x200B;**粘贴**:
...
* 发送供审阅流程LCA(SendLetterForReview.lca)的信函
...
1. 找到并单击&#x200B;**“Adobe LiveCycle客户端SDK配置”**。 出现“Adobe LiveCycle Client SDK Configuration”（客户端SDK配置）面板。
...
1. 更新DSCSample.jar中cmsa.properties中的AEM服务器URL，该URL位于以下位置：
...
1. 在配置文件中提供以下参数：
   ...
   * **crx.appRoot**=/content/apps/cm
   ...
   DSCSample.jar文件使用renderLetter API。 有关renderLetter API的详细信息，请参阅[接口LetterRenderService](https://helpx.adobe.com/aem-forms/6-2/javadocs/com/adobe/icc/ddg/api/LetterRenderService.html)。

#### 将DSC导入LiveCyle {#import-dsc-to-livecyle}

DSCSample.jar文件使用renderLetter API从C提供作为输入的XML数据将字母渲染为PDF字节。 有关renderLetter和其他API的详细信息，请参阅[Letter Render Service](https://helpx.adobe.com/aem-forms/6-2/javadocs/com/adobe/icc/ddg/api/LetterRenderService.html)。
...
1. 右键单击&#x200B;**RenderWrapper**&#x200B;并选择&#x200B;**开始组件**。 如果组件开始，则组件名称旁边将显示绿色箭头。
