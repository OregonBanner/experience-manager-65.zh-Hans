...
如果您是开发人员或站点所有者，则可以自定义Forms Portal（AEM Forms的最终用户界面）以反映您在组织中使用的元数据。 有关Forms Portal的详细信息，请参 [阅在门户上发布表单的介绍](../../forms/using/introduction-publishing-forms.md)。
...
#### 大量元数据列表 {#extensive-list-of-metadata}
