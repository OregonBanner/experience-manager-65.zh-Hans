...
1. 点按 **高级**。 高级选项卡包含更多字段。 这些字段中的大多数都包含默认值。
   ...
   * **** 包含模式文件：指定分号(;)分隔的模式列表，该列表由监视的文件夹用来确定要扫描和拾取的文件夹和文件。 例如，如果输入“包括文件模式”，则会选取所有与输入匹配的文件和文件夹。 有关详细信息，请参阅管 [理帮助](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
