...
+ 入门 {#getting-started}
   ...
   + AEM Forms Reference Acrobus {#aem-forms-reference-collaterals}
      + [设置和配置We.Finance和Employee自助服务参考站点](using/setup-reference-sites.md)
      ...
      + [We.Gov参考网站演练](/help/forms/using/forms-gov-reference-site-user-demo.md)
...
+ 安装和配置AEM表单 {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [在JEE上使用JBoss统包安装和部署AEM Forms](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      ...
      + [在JEE上安装和部署AEM Forms for JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_65)
...
+ 升级AEM Forms {#upgrade-aem-forms}
   ...
   + 在OSGi上升级AEM Forms {#aem-forms-osgi-upgrade}
      + [升级到OSGi上的AEM 6.5表单](using/upgrade-forms-osgi.md)
   ...
   + 在JEE上升级AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [从AEM Forms版本升级到JEE上的AEM 6.5 Forms forms for JBtowny](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [从AEM Forms版本升级到JEE上的AEM 6.5 Forms for WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
...
+ 工作流 {#workflows}
   ...
   + [配置离职](using/configure-out-of-office-settings.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [设计人员快速入门教程](http://www.adobe.com/go/learn_aemforms_designer_quick_start_65)
   ...
   + [设计器表单Calc参考](http://www.adobe.com/go/learn_aemforms_formCalc_65)
...
+ JEE上的AEM Forms管理员帮助 {#administrator-help}
   ...
   + 管理证书和凭据 {#manage-certificates-credentials}
      ...
      + [管理证书撤销列表](/help/forms/using/admin-help/certificate-revocation-lists.md)
...
+ 开发人员参考 {#developer-reference}
   ...
   + [JEE Java API参考上的AEM Forms](https://helpx.adobe.com/experience-manager/6-5/forms/programlc/javadoc/index.html)
   + [HTML5表单的Form Bridge API](using/form-bridge-apis.md)
   + [汇编器服务和DDX参考](http://www.adobe.com/go/learn_aemforms_ddxRef_65)
