...
+ 入门 {#getting-started}
   ...
   + 教程：创建您的第一个交互式通信{#create-first-interactive-communication}
      ...
      + [教程：创建交互通信](using/create-interactive-communication0.md)
   + AEM Forms参考抵押品{#aem-forms-reference-collaterals}
      ...
      + [We.Gov和We.Finance参考网站演练](/help/forms/using/forms-gov-reference-site-user-demo.md)
...
+ 升级AEM Forms {#upgrade-aem-forms}
   ...
   + 在JEE上升级AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager Forms on JEE升级核对清单和计划](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
      ...
      + [在JEE上升级到JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [在JEE for WebSphere上升级到Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
      + [在JEE for WebLogic上升级到Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [设计人员示例](http://www.adobe.com/go/learn_aemforms_designer_samples_65)
   + [设计人员脚本基础](http://www.adobe.com/go/learn_aemforms_scriptingBasics_65)
...
+ 开发人员参考{#developer-reference}
   + [开发人员基础](https://docs.adobe.com/content/help/en/experience-manager-65/developing/home.html)
   ...
   + [JavaScript库API参考，用于自适应Forms](https://helpx.adobe.com/experience-manager/6-5/forms/javascript-api/index.html)
