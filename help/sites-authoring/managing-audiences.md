...
在定位模式中，受众可用于 [创作目标内容](/help/sites-authoring/content-targeting-touch.md)，您还可以在该处创建受众(但必须在“受众”控制台中创建Adobe Target受众)。 您在定位模式下创建的受众将显示在受众控制台中。
...
您可以从受众控制台中编辑任何ContextHub或客户端上下文受众。 您还可以编辑Adobe Target受众，但只能编辑在AEM中创建的受众：

1. 在“导航”控制台中，单击或点按&#x200B;**个性化**。单击或点按&#x200B;**受众**。
1. 点按或单击要编辑的ContextHub或客户端上下文区段旁边的图标，然后点按或单击 **编辑**.
1. 在区段编辑器中进行任何编辑。参见 [客户端上下文](/help/sites-administering/campaign-segmentation.md) 或 [ContextHub](/help/sites-developing/ch-configuring.md) 文档。
