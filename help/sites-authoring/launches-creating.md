...
或者，您可以选择指定&#x200B;**启动日期**（和时间），以便定义何时提升和激活启动页面。However the **Launch Date** only operates in combination with the **Production Ready** flag (see [Editing a Launch Configuration](/help/sites-authoring/launches-editing.md#editing-a-launch-configuration)); for the actions to actually occur automatically, both must be set.
...
1. 根据您所使用的控制台，执行相应的操作：
   ...
   * **站点**：
   ...
   >[!NOTE]
   >
   >在&#x200B;**站点**&#x200B;控制台中，您还可以在选择&#x200B;**创建**&#x200B;之前使用[选择模式](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources)选择一个页面。
   >
   >这将使用选定的页面作为初始源页面。
