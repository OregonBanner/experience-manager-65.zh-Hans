...
在整个 AEM 环境中都可以使用各种键盘快捷键。有些適用於編輯頁面，有些則適用於 [使用主控台](/help/sites-authoring/keyboard-shortcuts.md).
...
>[!NOTE]
>
>&amp;ast；一旦使用者開始在「預覽模式」下與頁面互動， `Ctrl-Shift-m` 捷徑不再可用。 用户必须单击顶部编辑器栏或返回到“编辑”模式，才能使该快捷键再次变为可用。
