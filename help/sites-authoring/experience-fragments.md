...
>[!NOTE]
参见 [编辑页面内容](/help/sites-authoring/editing-content.md) 有关如何使用页面编辑器的更多信息。
...
1. 选择 **[配置](/help/sites-authoring/editing-content.md#edit-configure-copy-cut-delete-paste)** （从组件工具栏）。
1. 添加&#x200B;**资产**，并根据需要定义&#x200B;**属性**。
1. 使用以下方式确认定义 **完成** （勾选图标）。
1. 根据需要添加更多组件。
...
1. 打开片段，用于 [编辑](/help/sites-authoring/experience-fragments.md#editing-your-experience-fragment).
1. 打开&#x200B;**变体**&#x200B;选项卡。
...
要导出到Adobe Target，还可以使用JSON。 参见 [Target与体验片段的集成](/help/sites-administering/experience-fragments-target.md) 以获取完整信息。
