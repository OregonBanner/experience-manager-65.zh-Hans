...
通过“项目”，您可以将资源分组到一个实体中。通用共享环境使您能够轻松管理项目。可以与项目关联的资源类型在 AEM 中称为“拼贴”。拼贴可以包括项目和团队信息、资产、工作流和其他类型的信息，详情请参见 [项目图块。](#project-tiles)
...
![资产拼贴](assets/project-tile-assets.png)
...
![团队图块](assets/project-tile-team.png)
...
“任务”拼贴允许您监测任何项目相关任务（包括工作流）的状态。有关任务的详细信息，请参阅 [使用任务](/help/sites-authoring/task-content.md).
...
| 所有者 | 具有此角色的用户可以创建项目、在项目中启动工作，以及将已批准的资产移动到生产文件夹。 项目中的所有其他任务也可由所有者查看和执行。 | 写入权限 `/etc/commerce` | `dam-users` 组以能够创建项目<br>`project-administrators` 组以创建项目和移动资产 |
