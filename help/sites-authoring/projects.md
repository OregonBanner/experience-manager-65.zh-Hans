...
**电子邮件**&#x200B;拼贴可帮助您管理电子邮件请求。它会启动 **电子邮件请求** 工作流。
...
| 编辑者 | 具有此角色的用户可以上传和编辑项目的内容。 | 对项目、关联的元数据和相关资源的读写访问权限<br>上传拍摄列表、照片拍摄以及查看和批准资源的权限<br>写入权限 `/etc/commerce`<br>修改特定项目的权限 | `workflow-users` 组 |
